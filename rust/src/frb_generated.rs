...
fn wire_proton_wallet_auth_store_set_dart_callback_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "proton_wallet_auth_store_set_dart_callback", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_callback = decode_DartFn_Inputs_String_Output_String(<flutter_rust_bridge::DartOpaque>::sse_decode(&mut deserializer));deserializer.end();
                transform_result_sse((move || {
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        42 => wire_add_bitcoin_addresses_impl(port, ptr, rust_vec_len, data_len),
        39 => wire_add_email_address_impl(port, ptr, rust_vec_len, data_len),
        30 => wire_bitcoin_unit_impl(port, ptr, rust_vec_len, data_len),
        50 => wire_broadcast_raw_transaction_impl(port, ptr, rust_vec_len, data_len),
        36 => wire_collect_events_impl(port, ptr, rust_vec_len, data_len),
        22 => wire_create_wallet_impl(port, ptr, rust_vec_len, data_len),
        26 => wire_create_wallet_account_impl(port, ptr, rust_vec_len, data_len),
        47 => wire_create_wallet_transactions_impl(port, ptr, rust_vec_len, data_len),
        24 => wire_delete_wallet_impl(port, ptr, rust_vec_len, data_len),
        ...
        35 => wire_get_latest_event_id_impl(port, ptr, rust_vec_len, data_len),
        38 => wire_get_proton_address_impl(port, ptr, rust_vec_len, data_len),
        29 => wire_get_user_settings_impl(port, ptr, rust_vec_len, data_len),
        25 => wire_get_wallet_accounts_impl(port, ptr, rust_vec_len, data_len),
        44 => wire_get_wallet_bitcoin_address_impl(port, ptr, rust_vec_len, data_len),
        46 => wire_get_wallet_transactions_impl(port, ptr, rust_vec_len, data_len),
        21 => wire_get_wallets_impl(port, ptr, rust_vec_len, data_len),
        33 => wire_hide_empty_used_addresses_impl(port, ptr, rust_vec_len, data_len),
        18 => wire_init_api_service_impl(port, ptr, rust_vec_len, data_len),
        19 => wire_init_api_service_auth_store_impl(port, ptr, rust_vec_len, data_len),
        20 => wire_init_api_service_from_auth_and_version_impl(port, ptr, rust_vec_len, data_len),
        52 => wire_is_valid_token_impl(port, ptr, rust_vec_len, data_len),
        43 => wire_lookup_bitcoin_address_impl(port, ptr, rust_vec_len, data_len),
        40 => wire_remove_email_address_impl(port, ptr, rust_vec_len, data_len),
        32 => wire_two_fa_threshold_impl(port, ptr, rust_vec_len, data_len),
        41 => wire_update_bitcoin_address_impl(port, ptr, rust_vec_len, data_len),
        ...
        99 => wire_api_address_from_script_impl(port, ptr, rust_vec_len, data_len),
        101 => wire_api_address_network_impl(port, ptr, rust_vec_len, data_len),
        100 => wire_api_address_to_script_pubkey_impl(port, ptr, rust_vec_len, data_len),
        57 => wire_api_broadcast_impl(port, ptr, rust_vec_len, data_len),
        78 => wire_api_bump_fee_tx_builder_finish_impl(port, ptr, rust_vec_len, data_len),
        75 => wire_api_combine_psbt_impl(port, ptr, rust_vec_len, data_len),
        98 => wire_api_create_address_impl(port, ptr, rust_vec_len, data_len),
        95 => wire_api_create_derivation_path_impl(port, ptr, rust_vec_len, data_len),
        79 => wire_api_create_descriptor_impl(port, ptr, rust_vec_len, data_len),
        97 => wire_api_create_descriptor_public_impl(port, ptr, rust_vec_len, data_len),
        89 => wire_api_create_descriptor_secret_impl(port, ptr, rust_vec_len, data_len),
        53 => wire_api_create_esplora_blockchain_with_api_impl(port, ptr, rust_vec_len, data_len),
        58 => wire_api_create_transaction_impl(port, ptr, rust_vec_len, data_len),
        102 => wire_api_create_wallet_impl(port, ptr, rust_vec_len, data_len),
        92 => wire_api_derive_descriptor_secret_impl(port, ptr, rust_vec_len, data_len),
        87 => wire_api_descriptor_as_string_impl(port, ptr, rust_vec_len, data_len),
        86 => wire_api_descriptor_as_string_private_impl(port, ptr, rust_vec_len, data_len),
        96 => wire_api_descriptor_public_from_string_impl(port, ptr, rust_vec_len, data_len),
        94 => wire_api_descriptor_secret_as_public_impl(port, ptr, rust_vec_len, data_len),
        93 => wire_api_descriptor_secret_as_secret_bytes_impl(port, ptr, rust_vec_len, data_len),
        90 => wire_api_descriptor_secret_from_string_impl(port, ptr, rust_vec_len, data_len),
        56 => wire_api_estimate_fee_impl(port, ptr, rust_vec_len, data_len),
        91 => wire_api_extend_descriptor_secret_impl(port, ptr, rust_vec_len, data_len),
        72 => wire_api_extract_tx_impl(port, ptr, rust_vec_len, data_len),
        117 => wire_api_generate_seed_from_entropy_impl(port, ptr, rust_vec_len, data_len),
        116 => wire_api_generate_seed_from_string_impl(port, ptr, rust_vec_len, data_len),
        115 => wire_api_generate_seed_from_word_count_impl(port, ptr, rust_vec_len, data_len),
        103 => wire_api_get_address_impl(port, ptr, rust_vec_len, data_len),
        107 => wire_api_get_balance_impl(port, ptr, rust_vec_len, data_len),
        55 => wire_api_get_blockchain_hash_impl(port, ptr, rust_vec_len, data_len),
        114 => wire_api_get_descriptor_for_keychain_impl(port, ptr, rust_vec_len, data_len),
        54 => wire_api_get_height_impl(port, ptr, rust_vec_len, data_len),
        105 => wire_api_get_internal_address_impl(port, ptr, rust_vec_len, data_len),
        113 => wire_api_get_psbt_input_impl(port, ptr, rust_vec_len, data_len),
        109 => wire_api_get_transactions_impl(port, ptr, rust_vec_len, data_len),
        68 => wire_api_input_impl(port, ptr, rust_vec_len, data_len),
        63 => wire_api_is_coin_base_impl(port, ptr, rust_vec_len, data_len),
        64 => wire_api_is_explicitly_rbf_impl(port, ptr, rust_vec_len, data_len),
        65 => wire_api_is_lock_time_enabled_impl(port, ptr, rust_vec_len, data_len),
        104 => wire_api_is_mine_impl(port, ptr, rust_vec_len, data_len),
        76 => wire_api_json_serialize_impl(port, ptr, rust_vec_len, data_len),
        112 => wire_api_list_unspent_impl(port, ptr, rust_vec_len, data_len),
        108 => wire_api_list_unspent_outputs_impl(port, ptr, rust_vec_len, data_len),
        67 => wire_api_lock_time_impl(port, ptr, rust_vec_len, data_len),
        88 => wire_api_max_satisfaction_weight_impl(port, ptr, rust_vec_len, data_len),
        80 => wire_api_new_bip44_descriptor_impl(port, ptr, rust_vec_len, data_len),
        81 => wire_api_new_bip44_public_impl(port, ptr, rust_vec_len, data_len),
        82 => wire_api_new_bip49_descriptor_impl(port, ptr, rust_vec_len, data_len),
        83 => wire_api_new_bip49_public_impl(port, ptr, rust_vec_len, data_len),
        84 => wire_api_new_bip84_descriptor_impl(port, ptr, rust_vec_len, data_len),
        85 => wire_api_new_bip84_public_impl(port, ptr, rust_vec_len, data_len),
        69 => wire_api_output_impl(port, ptr, rust_vec_len, data_len),
        74 => wire_api_psbt_fee_amount_impl(port, ptr, rust_vec_len, data_len),
        73 => wire_api_psbt_fee_rate_impl(port, ptr, rust_vec_len, data_len),
        71 => wire_api_psbt_txid_impl(port, ptr, rust_vec_len, data_len),
        70 => wire_api_serialize_psbt_impl(port, ptr, rust_vec_len, data_len),
        110 => wire_api_sign_impl(port, ptr, rust_vec_len, data_len),
        61 => wire_api_size_impl(port, ptr, rust_vec_len, data_len),
        106 => wire_api_sync_wallet_impl(port, ptr, rust_vec_len, data_len),
        77 => wire_api_tx_builder_finish_impl(port, ptr, rust_vec_len, data_len),
        59 => wire_api_tx_txid_impl(port, ptr, rust_vec_len, data_len),
        66 => wire_api_version_impl(port, ptr, rust_vec_len, data_len),
        62 => wire_api_vsize_impl(port, ptr, rust_vec_len, data_len),
        111 => wire_api_wallet_network_impl(port, ptr, rust_vec_len, data_len),
        60 => wire_api_weight_impl(port, ptr, rust_vec_len, data_len),
        118 => wire_my_test_object_new_impl(port, ptr, rust_vec_len, data_len),
        119 => wire_my_test_object_read_text_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
