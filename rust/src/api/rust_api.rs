...
// use crate::common::esplora_config::EsploraConfig;
// use crate::common::transactions::FrbTransaction;
...
// use crate::bdk::types::{
//     to_input, AddressIndex, AddressInfo, Balance, ChangeSpendPolicy, KeychainKind, OutPoint,
//     PsbtSigHashType, RbfValue, ScriptAmount, TransactionDetails, TxIn, TxOut,
// };
...
impl Api {
    ...
    //=========Transaction===========
    // pub fn create_transaction(tx: Vec<u8>) -> Result<String, BridgeError> {
    //     let res = FrbTransaction::new(tx);
    //     match res {
    //         Ok(e) => Ok(e.into()),
    //         Err(e) => Err(e.into()),
    //     }
    ...
    // pub async fn serialize_psbt(psbt_str: String) -> Result<String, BridgeError> {
    ...
    //================Descriptor Public=========
    // pub async fn descriptor_public_from_string(public_key: String) -> Result<String, BridgeError> {
...
//         let mnemonic = FrbMnemonic::from_str(
