...
class Descriptor {
  ...
  static Future<Descriptor> create(
    ...
    try {
      final res = await RustFFIProvider.api.createDescriptorStaticMethodApi(
  ...
  Future<int> maxSatisfactionWeight() async {
    try {
      final res = await RustFFIProvider.api
          .maxSatisfactionWeightStaticMethodApi(
  ...
  static Future<Descriptor> newBip44(
    ...
    try {
      final res = await RustFFIProvider.api.newBip44DescriptorStaticMethodApi(
  ...
  static Future<Descriptor> newBip84(
      ...
      required bridge.KeychainKind keychain}) async {
    try {
      final res = await RustFFIProvider.api.newBip84DescriptorStaticMethodApi(
          secretKey: secretKey.asString(),
          network: network,
          keyChainKind: keychain);
      return Descriptor._(res, network);
...
class DescriptorSecretKey {
  ...
  static Future<DescriptorSecretKey> create(
    ...
    try {
      final res = await RustFFIProvider.api
          .createDescriptorSecretStaticMethodApi(
              network: network,
  ...
  Future<DescriptorSecretKey> derive(DerivationPath derivationPath) async {
    try {
      final res = await RustFFIProvider.api
          .deriveDescriptorSecretStaticMethodApi(
              secret: _descriptorSecretKey,
              path: derivationPath._path.toString());
      return DescriptorSecretKey._(res);
    } on bridge.Error catch (e) {
...
class TxBuilder {
  ...
  Future<TxBuilderResult> finish(Wallet wallet) async {
    ...
    try {
      final res = await RustFFIProvider.api.txBuilderFinishStaticMethodApi(
          walletId: wallet._wallet,
...
class Wallet {
  ...
  static Future<Wallet> create({
    ...
    try {
      final res = await RustFFIProvider.api.createWalletStaticMethodApi(
  ...
  Future<bridge.AddressInfo> getAddress(
    ...
    try {
      var res = await RustFFIProvider.api.getAddressStaticMethodApi(
  ...
  Future<bridge.Balance> getBalance() async {
    try {
      var res = await RustFFIProvider.api
          .getBalanceStaticMethodApi(walletId: _wallet);
      return res;
    } on bridge.Error catch (e) {
      throw handleBdkException(e);
    }
  ...
  Future<List<bridge.LocalUtxo>> listUnspent() async {
    try {
      var res = await RustFFIProvider.api
          .listUnspentOutputsStaticMethodApi(walletId: _wallet);
      return res;
    } on bridge.Error catch (e) {
      throw handleBdkException(e);
    }
  ...
  Future sync(Blockchain blockchain) async {
    try {
      await RustFFIProvider.api.syncWalletStaticMethodApi(
  ...
  Future<List<bridge.TransactionDetails>> listTransactions(
    ...
    try {
      final res = await RustFFIProvider.api.getTransactionsStaticMethodApi(
  ...
  Future<PartiallySignedTransaction> sign(
    ...
    try {
      final sbt = await RustFFIProvider.api.signStaticMethodApi(
  ...
  Future<Input> getPsbtInput({
    ...
    try {
      final res = await RustFFIProvider.api.getPsbtInputStaticMethodApi(
          walletId: _wallet,
          utxo: utxo,
