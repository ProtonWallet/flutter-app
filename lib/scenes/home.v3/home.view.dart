...
class HomeView extends ViewBase<HomeViewModel> {
  ...
  @override
  Widget buildWithViewModel(BuildContext context, HomeViewModel viewModel,
      ViewSize viewSize) {
    return Scaffold(
        ...
        ListTileTheme(
            ...
            child: ExpansionTile(
              ...
              backgroundColor: (Provider
                  ...
                  ? ProtonColors.drawerBackgroundHighlight
                  : Colors.transparent,
              initiallyExpanded: Provider
                  .of<ProtonWalletProvider>(context)
                  .protonWallet
                  .hasPassphrase(walletModel),
              leading: SvgPicture.asset(
                  "assets/images/icon/wallet-${Provider
                      .of<ProtonWalletProvider>(context)
                      .protonWallet
                      .wallets
                      .indexOf(walletModel) % 4}.svg",
                  fit: BoxFit.fill,
                  width: 18,
                  height: 18),
              title: Transform.translate(
                    ...
                    Material(
                        ...
                        child: ListTile(
                          ...
                          leading: Container(
                            ...
                            child: SvgPicture.asset(
                                "assets/images/icon/wallet-account-${Provider
                                    .of<ProtonWalletProvider>(context)
                                    .protonWallet
                                    .wallets
                                    .indexOf(walletModel) % 4}.svg",
...
Widget getWalletAccountBalanceWidget(BuildContext context,
  ...
  return Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
    Text(
        "${Provider.of<UserSettingProvider>(context)
            .getFiatCurrencySign()}${esitmateValue.toStringAsFixed(
