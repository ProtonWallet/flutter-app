...
import 'package:wallet/scenes/recovery.phone/recovery.phone.coordinator.dart';

abstract class RecoveryPhoneViewModel
    extends ViewModel<RecoveryPhoneCoordinator> {
  RecoveryPhoneViewModel(super.coordinator, this.protonRecoveryBloc);
...
class RecoveryPhoneViewModelImpl extends RecoveryPhoneViewModel {
  RecoveryPhoneViewModelImpl(
    super.coordinator,
