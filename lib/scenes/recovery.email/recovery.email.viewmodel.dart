...
import 'package:wallet/scenes/recovery.email/recovery.email.coordinator.dart';

abstract class RecoveryEmailViewModel
    extends ViewModel<RecoveryEmailCoordinator> {
  RecoveryEmailViewModel(super.coordinator, this.protonRecoveryBloc);
...
class RecoveryEmailViewModelImpl extends RecoveryEmailViewModel {
  RecoveryEmailViewModelImpl(
    super.coordinator,
