...
class SigninViewModelImpl extends SigninViewModel {
  ...
  Future<void> mockLogin() async {
    ...
    UserInfo userInfo = UserInfo(
        ...
        sessionId: "uvgquyxt2ojuhry24ujdquaszmtyy6cz",
        accessToken: "uandw5woblyugdpfikbnsigxqlugpm2d",
        refreshToken: "lszwkws6cu7k57efdh3mqaupog6vma7r",
...
-----END PGP PRIVATE KEY BLOCK-----''',
  ...
  Future<void> mockLoginAtlasPro() async {
    ...
    UserInfo userInfo = UserInfo(
        ...
        userName: "pro",
        userDisplayName: "pro",
        sessionId: "yjzpaaoss6y3hrc4xzubzm24a7kyvggu",
        accessToken: "3oyqo4d3leeyogxu4ieiucfv3lonfv2e",
        refreshToken: "n246ni5ilffbwdodlu7z333bzwe6rpvr",
        scopes: "full,locked,self,payments,keys,parent,user,loggedin,nondelinquent,verified,settings,wallet",
