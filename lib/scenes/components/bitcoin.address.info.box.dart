  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        GestureDetector(
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(Icons.copy_rounded, color: ProtonColors.textWeak, size: 20),
        ...
        //   ),
        //   Text(
        //     bitcoinAddressDetail.keychain == KeychainKind.external_
        //         ? context.local.receive_address
        //         : context.local.change_address,
        //     style: ProtonStyles.body2Regular(color: ProtonColors.textWeak),
        //   ),
        // ]),
        Row(children: [
