...
class ProtonWalletCommonImpl implements ProtonWalletCommon {
  ...
  Future<String> descriptorAsStringStaticMethodApi(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_descriptor_as_string__static_method__Api(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
      parseErrorData: _wire2api_error,
  ...
  Future<String> descriptorSecretAsPublicStaticMethodApi(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_descriptor_secret_as_public__static_method__Api(port_, arg0),
      parseSuccessData: _wire2api_String,
      parseErrorData: _wire2api_error,
  ...
  Future<bool> isMineStaticMethodApi(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_is_mine__static_method__Api(port_, arg0, arg1),
      parseSuccessData: _wire2api_bool,
      parseErrorData: _wire2api_error,
...
// Section: wire2api
  ...
  (String, TransactionDetails) _wire2api___record__String_transaction_details(
      dynamic raw) {
    final arr = raw as List<dynamic>;
    if (arr.length != 2) {
      throw Exception('Expected 2 elements, got ${arr.length}');
...
class ProtonWalletCommonPlatform
    extends FlutterRustBridgeBase<ProtonWalletCommonWire> {
  ProtonWalletCommonPlatform(ffi.DynamicLibrary dylib)
      : super(ProtonWalletCommonWire(dylib));
