...
class ProtonWalletCommonImpl implements ProtonWalletCommon {
                final ProtonWalletCommonPlatform _platform;
                factory ProtonWalletCommonImpl(ExternalLibrary dylib) => ProtonWalletCommonImpl.raw(ProtonWalletCommonPlatform(dylib));
...
Future<String> getBlockchainHashStaticMethodApi({ required int blockchainHeight ,required String blockchainId ,dynamic hint }) {
...
Future<(String,TransactionDetails)> txBuilderFinishStaticMethodApi({ required String walletId ,required List<ScriptAmount> recipients ,required List<OutPoint> utxos ,(OutPoint,String,int)? foreignUtxo ,required List<OutPoint> unspendable ,required ChangeSpendPolicy changePolicy ,required bool manuallySelectedOnly ,double? feeRate ,int? feeAbsolute ,required bool drainWallet ,Script? drainTo ,RbfValue? rbf ,required Uint8List data ,dynamic hint }) {
...
var arg3 = _platform.api2wire_opt_box_autoadd___record__out_point_String_usize(foreignUtxo);
...
var arg12 = _platform.api2wire_uint_8_list(data);
        ...
        argValues: [walletId, recipients, utxos, foreignUtxo, unspendable, changePolicy, manuallySelectedOnly, feeRate, feeAbsolute, drainWallet, drainTo, rbf, data],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kTxBuilderFinishStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
            ...
            argNames: ["walletId", "recipients", "utxos", "foreignUtxo", "unspendable", "changePolicy", "manuallySelectedOnly", "feeRate", "feeAbsolute", "drainWallet", "drainTo", "rbf", "data"],
        );
        
Future<(String,TransactionDetails)> bumpFeeTxBuilderFinishStaticMethodApi({ required String txid ,required double feeRate ,String? allowShrinking ,required String walletId ,required bool enableRbf ,int? nSequence ,dynamic hint }) {
...
var arg5 = _platform.api2wire_opt_box_autoadd_u32(nSequence);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_bump_fee_tx_builder_finish__static_method__Api(port_, arg0, arg1, arg2, arg3, arg4, arg5),
            parseSuccessData: _wire2api___record__String_transaction_details,
            parseErrorData: _wire2api_error,
...
Future<String> newBip44DescriptorStaticMethodApi({ required KeychainKind keyChainKind ,required String secretKey ,required Network network ,dynamic hint }) {
...
Future<String> newBip44PublicStaticMethodApi({ required KeychainKind keyChainKind ,required String publicKey ,required Network network ,required String fingerprint ,dynamic hint }) {
            var arg0 = api2wire_keychain_kind(keyChainKind);
...
Future<String> newBip49DescriptorStaticMethodApi({ required KeychainKind keyChainKind ,required String secretKey ,required Network network ,dynamic hint }) {
            var arg0 = api2wire_keychain_kind(keyChainKind);
var arg1 = _platform.api2wire_String(secretKey);
var arg2 = api2wire_network(network);
            return _platform.executeNormal(FlutterRustBridgeTask(
...
Future<String> newBip49PublicStaticMethodApi({ required KeychainKind keyChainKind ,required String publicKey ,required Network network ,required String fingerprint ,dynamic hint }) {
            var arg0 = api2wire_keychain_kind(keyChainKind);
var arg1 = _platform.api2wire_String(publicKey);
var arg2 = api2wire_network(network);
var arg3 = _platform.api2wire_String(fingerprint);
...
Future<String> newBip84DescriptorStaticMethodApi({ required KeychainKind keyChainKind ,required String secretKey ,required Network network ,dynamic hint }) {
            var arg0 = api2wire_keychain_kind(keyChainKind);
var arg1 = _platform.api2wire_String(secretKey);
var arg2 = api2wire_network(network);
            return _platform.executeNormal(FlutterRustBridgeTask(
...
Future<String> newBip84PublicStaticMethodApi({ required KeychainKind keyChainKind ,required String publicKey ,required Network network ,required String fingerprint ,dynamic hint }) {
            var arg0 = api2wire_keychain_kind(keyChainKind);
var arg1 = _platform.api2wire_String(publicKey);
var arg2 = api2wire_network(network);
var arg3 = _platform.api2wire_String(fingerprint);
...
Future<String> descriptorAsStringPrivateStaticMethodApi({ required String descriptor ,required Network network ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(descriptor);
var arg1 = api2wire_network(network);
            return _platform.executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kDescriptorAsStringPrivateStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "descriptor_as_string_private__static_method__Api",
            argNames: ["descriptor", "network"],
        );
        
Future<String> descriptorAsStringStaticMethodApi({ required String descriptor ,required Network network ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(descriptor);
var arg1 = api2wire_network(network);
            return _platform.executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kDescriptorAsStringStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "descriptor_as_string__static_method__Api",
            argNames: ["descriptor", "network"],
        );
        
Future<int> maxSatisfactionWeightStaticMethodApi({ required String descriptor ,required Network network ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(descriptor);
var arg1 = api2wire_network(network);
            return _platform.executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kMaxSatisfactionWeightStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<Uint8List> descriptorSecretAsSecretBytesStaticMethodApi({ required String secret ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kDescriptorSecretAsSecretBytesStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> descriptorSecretAsPublicStaticMethodApi({ required String secret ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kDescriptorSecretAsPublicStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<String> createWalletStaticMethodApi({ required String descriptor ,String? changeDescriptor ,required Network network ,required DatabaseConfig databaseConfig ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(descriptor);
...
Future<AddressInfo> getAddressStaticMethodApi({ required String walletId ,required AddressIndex addressIndex ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
...
Future<bool> isMineStaticMethodApi({ required Script script ,required String walletId ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_script(script);
var arg1 = _platform.api2wire_String(walletId);
            return _platform.executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kIsMineStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "is_mine__static_method__Api",
            argNames: ["script", "walletId"],
        );
        
Future<AddressInfo> getInternalAddressStaticMethodApi({ required String walletId ,required AddressIndex addressIndex ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
var arg1 = _platform.api2wire_box_autoadd_address_index(addressIndex);
            return _platform.executeNormal(FlutterRustBridgeTask(
...
Future<List<TransactionDetails>> getTransactionsStaticMethodApi({ required String walletId ,required bool includeRaw ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
var arg1 = includeRaw;
            return _platform.executeNormal(FlutterRustBridgeTask(
...
Future<String?> signStaticMethodApi({ required String walletId ,required String psbtStr ,SignOptions? signOptions ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
...
Future<String> getPsbtInputStaticMethodApi({ required String walletId ,required LocalUtxo utxo ,required bool onlyWitnessUtxo ,PsbtSigHashType? psbtSighashType ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
...
Future<(String,Network)> getDescriptorForKeychainStaticMethodApi({ required String walletId ,required KeychainKind keychain ,dynamic hint }) {
            var arg0 = _platform.api2wire_String(walletId);
var arg1 = api2wire_keychain_kind(keychain);
        ...
        FlutterRustBridgeTaskConstMeta get kGetDescriptorForKeychainStaticMethodApiConstMeta => const FlutterRustBridgeTaskConstMeta(
...
(String,Network) _wire2api___record__String_network(dynamic raw) {
            ...
            return (_wire2api_String(arr[0]),_wire2api_network(arr[1]),);
        }
...
(String,TransactionDetails) _wire2api___record__String_transaction_details(dynamic raw) {
            ...
            return (_wire2api_String(arr[0]),_wire2api_transaction_details(arr[1]),);
        }
...
AddressInfo _wire2api_address_info(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return AddressInfo(index: _wire2api_u32(arr[0]),
...
Balance _wire2api_balance(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Balance(immature: _wire2api_u64(arr[0]),
...
BlockTime _wire2api_block_time(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return BlockTime(height: _wire2api_u32(arr[0]),
...
Error _wire2api_error(dynamic raw) {
            switch (raw[0]) {
                case 0: return Error_InvalidU32Bytes(_wire2api_uint_8_list(raw[1]),);
case 1: return Error_Generic(_wire2api_String(raw[1]),);
case 2: return Error_ScriptDoesntHaveAddressForm();
case 3: return Error_NoRecipients();
case 4: return Error_NoUtxosSelected();
case 5: return Error_OutputBelowDustLimit(_wire2api_usize(raw[1]),);
case 6: return Error_InsufficientFunds(needed: _wire2api_u64(raw[1]),available: _wire2api_u64(raw[2]),);
case 7: return Error_BnBTotalTriesExceeded();
case 8: return Error_BnBNoExactMatch();
case 9: return Error_UnknownUtxo();
case 10: return Error_TransactionNotFound();
case 11: return Error_TransactionConfirmed();
case 12: return Error_IrreplaceableTransaction();
case 13: return Error_FeeRateTooLow(required: _wire2api_f32(raw[1]),);
case 14: return Error_FeeTooLow(required: _wire2api_u64(raw[1]),);
case 15: return Error_FeeRateUnavailable();
case 16: return Error_MissingKeyOrigin(_wire2api_String(raw[1]),);
case 17: return Error_Key(_wire2api_String(raw[1]),);
case 18: return Error_ChecksumMismatch();
case 19: return Error_SpendingPolicyRequired(_wire2api_keychain_kind(raw[1]),);
case 20: return Error_InvalidPolicyPathError(_wire2api_String(raw[1]),);
case 21: return Error_Signer(_wire2api_String(raw[1]),);
case 22: return Error_InvalidNetwork(requested: _wire2api_network(raw[1]),found: _wire2api_network(raw[2]),);
case 23: return Error_InvalidOutpoint(_wire2api_box_autoadd_out_point(raw[1]),);
case 24: return Error_Descriptor(_wire2api_String(raw[1]),);
case 25: return Error_Encode(_wire2api_String(raw[1]),);
case 26: return Error_Miniscript(_wire2api_String(raw[1]),);
case 27: return Error_MiniscriptPsbt(_wire2api_String(raw[1]),);
case 28: return Error_Bip32(_wire2api_String(raw[1]),);
case 29: return Error_Secp256k1(_wire2api_String(raw[1]),);
case 30: return Error_Json(_wire2api_String(raw[1]),);
case 31: return Error_Hex(_wire2api_String(raw[1]),);
case 32: return Error_Psbt(_wire2api_String(raw[1]),);
case 33: return Error_PsbtParse(_wire2api_String(raw[1]),);
case 34: return Error_MissingCachedScripts(_wire2api_usize(raw[1]),_wire2api_usize(raw[2]),);
case 35: return Error_Electrum(_wire2api_String(raw[1]),);
case 36: return Error_Esplora(_wire2api_String(raw[1]),);
case 37: return Error_Sled(_wire2api_String(raw[1]),);
case 38: return Error_Rpc(_wire2api_String(raw[1]),);
case 39: return Error_Rusqlite(_wire2api_String(raw[1]),);
...
LocalUtxo _wire2api_local_utxo(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return LocalUtxo(outpoint: _wire2api_out_point(arr[0]),
...
OutPoint _wire2api_out_point(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return OutPoint(txid: _wire2api_String(arr[0]),
...
Payload _wire2api_payload(dynamic raw) {
            switch (raw[0]) {
                case 0: return Payload_PubkeyHash(pubkeyHash: _wire2api_uint_8_list(raw[1]),);
case 1: return Payload_ScriptHash(scriptHash: _wire2api_uint_8_list(raw[1]),);
case 2: return Payload_WitnessProgram(version: _wire2api_witness_version(raw[1]),program: _wire2api_uint_8_list(raw[2]),);
                default: throw Exception("unreachable");
            }
        }
...
Script _wire2api_script(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return Script(internal: _wire2api_uint_8_list(arr[0]),);
        }
...
TransactionDetails _wire2api_transaction_details(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 6) throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
                return TransactionDetails(serializedTx: _wire2api_opt_String(arr[0]),
...
TxIn _wire2api_tx_in(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
                return TxIn(previousOutput: _wire2api_out_point(arr[0]),
...
TxOut _wire2api_tx_out(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return TxOut(value: _wire2api_u64(arr[0]),
...
class ProtonWalletCommonPlatform extends FlutterRustBridgeBase<ProtonWalletCommonWire> {
                ProtonWalletCommonPlatform(ffi.DynamicLibrary dylib) : super(ProtonWalletCommonWire(dylib));
...
@protected
                    ffi.Pointer<wire___record__out_point_String_usize> api2wire_box_autoadd___record__out_point_String_usize((OutPoint,String,int) raw) {
...
@protected
                    ffi.Pointer<wire___record__out_point_String_usize> api2wire_opt_box_autoadd___record__out_point_String_usize((OutPoint,String,int)? raw) {
                        return raw == null ? ffi.nullptr : api2wire_box_autoadd___record__out_point_String_usize(raw);
                    }
@protected
...
void _api_fill_to_wire___record__out_point_String_usize((OutPoint,String,int) apiObj, wire___record__out_point_String_usize wireObj) {
...
void _api_fill_to_wire_address_index(AddressIndex apiObj, wire_AddressIndex wireObj) {
                if (apiObj is AddressIndex_New) { wireObj.tag = 0; return; }
if (apiObj is AddressIndex_LastUnused) { wireObj.tag = 1; return; }
...
void _api_fill_to_wire_box_autoadd___record__out_point_String_usize((OutPoint,String,int) apiObj, ffi.Pointer<wire___record__out_point_String_usize> wireObj) {
...
void _api_fill_to_wire_box_autoadd_psbt_sig_hash_type(PsbtSigHashType apiObj, ffi.Pointer<wire_PsbtSigHashType> wireObj) {
...
void _api_fill_to_wire_database_config(DatabaseConfig apiObj, wire_DatabaseConfig wireObj) {
                if (apiObj is DatabaseConfig_Memory) { wireObj.tag = 0; return; }
...
void _api_fill_to_wire_opt_box_autoadd___record__out_point_String_usize((OutPoint,String,int)? apiObj, ffi.Pointer<wire___record__out_point_String_usize> wireObj) {
                if (apiObj != null) _api_fill_to_wire_box_autoadd___record__out_point_String_usize(apiObj, wireObj);
            }



void _api_fill_to_wire_opt_box_autoadd_psbt_sig_hash_type(PsbtSigHashType? apiObj, ffi.Pointer<wire_PsbtSigHashType> wireObj) {
...
void _api_fill_to_wire_rbf_value(RbfValue apiObj, wire_RbfValue wireObj) {
                if (apiObj is RbfValue_RbfDefault) { wireObj.tag = 0; return; }
...
class ProtonWalletCommonWire implements FlutterRustBridgeWireBase {
            @internal
  ...
  ProtonWalletCommonWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ProtonWalletCommonWire.fromLookup(
  ...
  late final _wire_descriptor_as_string__static_method__ApiPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
              ffi.Int32)>>('wire_descriptor_as_string__static_method__Api');
  late final _wire_descriptor_as_string__static_method__Api =
      _wire_descriptor_as_string__static_method__ApiPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>, int)>();
  ...
  late final _wire_descriptor_secret_as_public__static_method__ApiPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
  ...
  void wire_is_mine__static_method__Api(
    int port_,
    ffi.Pointer<wire_Script> script,
    ffi.Pointer<wire_uint_8_list> wallet_id,
  ) {
    return _wire_is_mine__static_method__Api(
      port_,
      script,
      wallet_id,
    );
  ...
  late final _wire_is_mine__static_method__ApiPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_Script>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_is_mine__static_method__Api');
  late final _wire_is_mine__static_method__Api =
      _wire_is_mine__static_method__ApiPtr.asFunction<
          void Function(
              int, ffi.Pointer<wire_Script>, ffi.Pointer<wire_uint_8_list>)>();
...
final class wire_TxOut extends ffi.Struct {
  @ffi.Uint64()
  external int value;
...
final class wire_LocalUtxo extends ffi.Struct {
...
final class wire_PsbtSigHashType extends ffi.Struct {
  @ffi.Uint32()
  external int inner;
}
