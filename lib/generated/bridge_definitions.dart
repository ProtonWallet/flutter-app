...
final String address;
                    ...
                    const AddressInfo({required this.index ,required this.address ,});
...
final int total;
                    ...
                    const Balance({required this.immature ,required this.trustedPending ,required this.untrustedPending ,required this.confirmed ,required this.spendable ,required this.total ,});
...
@freezed
                 class BlockchainConfig with _$BlockchainConfig  {
                     /// Esplora client
const factory BlockchainConfig.esplora({   required EsploraConfig config , }) = BlockchainConfig_Esplora;
                }
...
const factory DatabaseConfig.sqlite({   required SqliteDbConfiguration config , }) = DatabaseConfig_Sqlite;
 ///Sqlite embedded database using rusqlite
const factory DatabaseConfig.sled({   required SledDbConfiguration config , }) = DatabaseConfig_Sled;
                }

@freezed
                 class Error with _$Error implements FrbException {
                     /// Wrong number of bytes found when trying to convert to u32
const factory Error.invalidU32Bytes(  Uint8List field0,) = Error_InvalidU32Bytes;
 /// Generic error
const factory Error.generic(  String field0,) = Error_Generic;
...
const factory Error.outputBelowDustLimit(  int field0,) = Error_OutputBelowDustLimit;
 /// Wallet's UTXO set is not enough to cover recipient's requested plus fee
const factory Error.insufficientFunds({ /// Sats needed for some transaction
  required int needed ,/// Sats available for spending
  required int available , }) = Error_InsufficientFunds;
...
const factory Error.feeRateTooLow({ /// Required fee rate (satoshi/vbyte)
  required double required , }) = Error_FeeRateTooLow;
 /// When bumping a tx the absolute fee requested is lower than replaced tx absolute fee
const factory Error.feeTooLow({ /// Required fee absolute value (satoshi)
  required int required , }) = Error_FeeTooLow;
 /// Node doesn't have data to estimate a fee rate
const factory Error.feeRateUnavailable() = Error_FeeRateUnavailable;
 const factory Error.missingKeyOrigin(  String field0,) = Error_MissingKeyOrigin;
 /// Error while working with keys
const factory Error.key(  String field0,) = Error_Key;
 /// Descriptor checksum mismatch
const factory Error.checksumMismatch() = Error_ChecksumMismatch;
 /// Spending policy is not compatible with this [`KeychainKind`]
const factory Error.spendingPolicyRequired(  KeychainKind field0,) = Error_SpendingPolicyRequired;
 /// Error while extracting and manipulating policies
const factory Error.invalidPolicyPathError(  String field0,) = Error_InvalidPolicyPathError;
 /// Signing error
const factory Error.signer(  String field0,) = Error_Signer;
 /// Invalid network
const factory Error.invalidNetwork({ /// requested network, for example what is given as bdk-cli option
  required Network requested ,/// found network, for example the network of the bitcoin node
  required Network found , }) = Error_InvalidNetwork;
 /// Requested outpoint doesn't exist in the tx (vout greater than available outputs)
const factory Error.invalidOutpoint(  OutPoint field0,) = Error_InvalidOutpoint;
 /// Error related to the parsing and usage of descriptors
const factory Error.descriptor(  String field0,) = Error_Descriptor;
 /// Encoding error
const factory Error.encode(  String field0,) = Error_Encode;
 /// Miniscript error
const factory Error.miniscript(  String field0,) = Error_Miniscript;
 /// Miniscript PSBT error
const factory Error.miniscriptPsbt(  String field0,) = Error_MiniscriptPsbt;
 /// BIP32 error
const factory Error.bip32(  String field0,) = Error_Bip32;
 /// A secp256k1 error
const factory Error.secp256K1(  String field0,) = Error_Secp256k1;
 /// Error serializing or deserializing JSON data
const factory Error.json(  String field0,) = Error_Json;
 /// Hex decoding error
const factory Error.hex(  String field0,) = Error_Hex;
 /// Partially signed bitcoin transaction error
const factory Error.psbt(  String field0,) = Error_Psbt;
 /// Partially signed bitcoin transaction parse error
const factory Error.psbtParse(  String field0,) = Error_PsbtParse;
 ///  sync attempt failed due to missing scripts in cache which
/// are needed to satisfy `stop_gap`.
const factory Error.missingCachedScripts(  int field0,  int field1,) = Error_MissingCachedScripts;
 /// Electrum client error
const factory Error.electrum(  String field0,) = Error_Electrum;
 /// Esplora client error
const factory Error.esplora(  String field0,) = Error_Esplora;
 /// Sled database error
const factory Error.sled(  String field0,) = Error_Sled;
 /// Rpc client error
const factory Error.rpc(  String field0,) = Error_Rpc;
 /// Rusqlite client error
const factory Error.rusqlite(  String field0,) = Error_Rusqlite;
                }
...
final int? timeout;
                    ...
                    const EsploraConfig({required this.baseUrl ,this.proxy ,this.concurrency ,required this.stopGap ,this.timeout ,});
...
final KeychainKind keychain;
                    ...
                    const LocalUtxo({required this.outpoint ,required this.txout ,required this.isSpent ,required this.keychain ,});
...
@freezed
                 class Payload with _$Payload  {
                     /// P2PKH address.
const factory Payload.pubkeyHash({   required Uint8List pubkeyHash , }) = Payload_PubkeyHash;
 /// P2SH address.
const factory Payload.scriptHash({   required Uint8List scriptHash , }) = Payload_ScriptHash;
 /// Segwit address.
const factory Payload.witnessProgram({ /// The witness program version.
  required WitnessVersion version ,/// The witness program.
  required Uint8List program , }) = Payload_WitnessProgram;
                }
...
class Script  {
                    ...
                    const Script({required this.internal ,});
...
final bool allowGrinding;
                    ...
                    const SignOptions({required this.isMultiSig ,required this.trustWitnessUtxo ,this.assumeHeight ,required this.allowAllSighashes ,required this.removePartialSigs ,required this.tryFinalize ,required this.signWithTapInternalKey ,required this.allowGrinding ,});
...
final BlockTime? confirmationTime;
                    ...
                    const TransactionDetails({this.serializedTx ,required this.txid ,required this.received ,required this.sent ,this.fee ,this.confirmationTime ,});
...
final List<String> witness;
                    ...
                    const TxIn({required this.previousOutput ,required this.scriptSig ,required this.sequence ,required this.witness ,});
