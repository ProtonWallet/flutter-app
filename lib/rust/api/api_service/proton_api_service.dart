...
class ProtonApiService extends RustOpaque {
  ...
  Future<List<WalletData>> getWallets({dynamic hint}) => RustLib.instance.api
  ...
  static Future<void> initApiService(
      ...
      RustLib.instance.api
          .crateApiApiServiceProtonApiServiceProtonApiServiceInitApiService(
              userName: userName, password: password, hint: hint);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<ProtonApiService> newInstance({dynamic hint}) =>
      RustLib.instance.api
          .crateApiApiServiceProtonApiServiceProtonApiServiceNew(hint: hint);

  Future<String> readText({dynamic hint}) => RustLib.instance.api
      .crateApiApiServiceProtonApiServiceProtonApiServiceReadText(
          that: this, hint: hint);
}
