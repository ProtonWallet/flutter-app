...
Future<void> test({required int i, dynamic hint}) =>
    RustLib.instance.api.crateApiFlutterLoggerTest(i: i, hint: hint);

Future<void> panic({dynamic hint}) =>
    RustLib.instance.api.crateApiFlutterLoggerPanic(hint: hint);

Stream<LogEntry> infoLogger({dynamic hint}) =>
    RustLib.instance.api.crateApiFlutterLoggerInfoLogger(hint: hint);
