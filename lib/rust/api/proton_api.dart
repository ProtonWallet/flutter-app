...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::rust_async::RwLock<andromeda_api :: wallet :: WalletData>>
@sealed
class AndromedaApiWalletWalletData extends RustOpaque {
  AndromedaApiWalletWalletData.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  AndromedaApiWalletWalletData.sseDecode(int ptr, int externalSizeOnNative)
      : super.sseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib.instance.api
        .rust_arc_increment_strong_count_AndromedaApiWalletWalletData,
    rustArcDecrementStrongCount: RustLib.instance.api
        .rust_arc_decrement_strong_count_AndromedaApiWalletWalletData,
    rustArcDecrementStrongCountPtr: RustLib.instance.api
        .rust_arc_decrement_strong_count_AndromedaApiWalletWalletDataPtr,
  );
}
...
class ProtonAPIService {
  ...
  Future<List<AndromedaApiWalletWalletData>> getWallets({dynamic hint}) =>
