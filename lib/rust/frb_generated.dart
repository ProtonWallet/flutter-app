...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -780964723;
...
abstract class RustLibApi extends BaseApi {
  Future<int> crateApiApi2AddOne(
      {required int left, required int right, dynamic hint});

  Future<int> crateApiApi2AddThree(
      {required int left, required int right, dynamic hint});

  String crateApiApi2Greet({required String name, dynamic hint});

  String crateApiApi2Helloworld({dynamic hint});

  Future<void> crateApiApi2InitApp({dynamic hint});

  Future<List<WalletData>>
      crateApiApiServiceProtonApiServiceProtonApiServiceGetWallets(
          {required ProtonApiService that, dynamic hint});

  Future<void> crateApiApiServiceProtonApiServiceProtonApiServiceInitApiService(
      {required String userName, required String password, dynamic hint});

  Future<ProtonApiService>
      crateApiApiServiceProtonApiServiceProtonApiServiceNew({dynamic hint});

  Future<String> crateApiApiServiceProtonApiServiceProtonApiServiceReadText(
      {required ProtonApiService that, dynamic hint});

  void crateApiApiServiceWalletAuthStoreProtonWalletAuthStoreSetDartCallback(
      {required FutureOr<String> Function(String) callback, dynamic hint});

  String crateApiBdkWalletBdkWalletManagerFingerprint(
      {required BdkWalletManager that, dynamic hint});

  Future<BdkWalletManager> crateApiBdkWalletBdkWalletManagerNew(
      {required Network network,
      required String bip39Mnemonic,
      String? bip38Passphrase,
      dynamic hint});

  Stream<LogEntry> crateApiFlutterLoggerInfoLogger({dynamic hint});

  Future<void> crateApiFlutterLoggerPanic({dynamic hint});

  Future<void> crateApiFlutterLoggerTest({required int i, dynamic hint});

  Future<int> crateApiLdkApiAddTwo(
      {required int left, required int right, dynamic hint});

  Future<String> crateApiLdkApiTestOne({dynamic hint});

  Future<List<WalletBitcoinAddress>> crateApiProtonApiAddBitcoinAddresses(
      {required String walletId,
      required String walletAccountId,
      required List<BitcoinAddress> bitcoinAddresses,
      dynamic hint});

  Future<WalletAccount> crateApiProtonApiAddEmailAddress(
      {required String walletId,
      required String walletAccountId,
      required String addressId,
      dynamic hint});

  Future<ApiUserSettings> crateApiProtonApiBitcoinUnit(
      {required BitcoinUnit symbol, dynamic hint});

  Future<String> crateApiProtonApiBroadcastRawTransaction(
  ...
  Future<WalletData> crateApiProtonApiCreateWallet(
      {required CreateWalletReq walletReq, dynamic hint});

  Future<WalletAccount> crateApiProtonApiCreateWalletAccount(
      {required String walletId,
  ...
  Future<void> crateApiProtonApiDeleteWallet(
  ...
  Future<ApiUserSettings> crateApiProtonApiFiatCurrency(
  ...
  Future<int> crateApiProtonApiGetBitcoinAddressLatestIndex(
      {required String walletId,
      required String walletAccountId,
      dynamic hint});

  Future<List<ProtonContactEmails>> crateApiProtonApiGetContacts(
      {dynamic hint});

  Future<ProtonExchangeRate> crateApiProtonApiGetExchangeRate(
      {required FiatCurrency fiatCurrency, int? time, dynamic hint});

  Future<String> crateApiProtonApiGetLatestEventId({dynamic hint});

  Future<List<ProtonAddress>> crateApiProtonApiGetProtonAddress({dynamic hint});

  Future<ApiUserSettings> crateApiProtonApiGetUserSettings({dynamic hint});

  Future<List<WalletAccount>> crateApiProtonApiGetWalletAccounts(
      {required String walletId, dynamic hint});

  Future<List<WalletBitcoinAddress>> crateApiProtonApiGetWalletBitcoinAddress(
      {required String walletId,
      required String walletAccountId,
      int? onlyRequest,
      dynamic hint});
  ...
  Future<List<WalletData>> crateApiProtonApiGetWallets({dynamic hint});

  Future<ApiUserSettings> crateApiProtonApiHideEmptyUsedAddresses(
      {required bool hideEmptyUsedAddresses, dynamic hint});

  Future<void> crateApiProtonApiInitApiService(
      {required String userName, required String password, dynamic hint});

  Future<void> crateApiProtonApiInitApiServiceAuthStore(
      {required String uid,
  ...
  Future<void> crateApiProtonApiInitApiServiceFromAuthAndVersion(
      {required String uid,
      required String access,
      required String refresh,
      required List<String> scopes,
  ...
  Future<bool> crateApiProtonApiIsValidToken({dynamic hint});

  Future<EmailIntegrationBitcoinAddress> crateApiProtonApiLookupBitcoinAddress(
      {required String email, dynamic hint});

  Future<WalletAccount> crateApiProtonApiRemoveEmailAddress(
      {required String walletId,
      required String walletAccountId,
      required String addressId,
      dynamic hint});

  Future<ApiUserSettings> crateApiProtonApiTwoFaThreshold(
      {required int amount, dynamic hint});

  Future<WalletBitcoinAddress> crateApiProtonApiUpdateBitcoinAddress(
      {required String walletId,
      required String walletAccountId,
  ...
  Future<WalletAccount> crateApiProtonApiUpdateWalletAccountLabel(
      {required String walletId,
      required String walletAccountId,
      required String newLabel,
      dynamic hint});

  Future<ProtonWallet> crateApiProtonApiUpdateWalletName(
  ...
  Future<String> crateApiRustApiApiAddressFromScript(
      {required Script script, required Network network, dynamic hint});

  Future<Network> crateApiRustApiApiAddressNetwork(
      {required String address, dynamic hint});

  Future<Script> crateApiRustApiApiAddressToScriptPubkey(
      {required String address, dynamic hint});

  Future<String> crateApiRustApiApiBroadcast(
      {required String tx, required String blockchainId, dynamic hint});

  Future<(String, TransactionDetails)> crateApiRustApiApiBumpFeeTxBuilderFinish(
  ...
  Future<String> crateApiRustApiApiCombinePsbt(
      {required String psbtStr, required String other, dynamic hint});

  Future<String> crateApiRustApiApiCreateAddress(
      {required String address, dynamic hint});

  Future<String> crateApiRustApiApiCreateDerivationPath(
      {required String path, dynamic hint});

  Future<String> crateApiRustApiApiCreateDescriptor(
      {required String descriptor, required Network network, dynamic hint});

  Future<String> crateApiRustApiApiCreateDescriptorPublic(
      {String? xpub, required String path, required bool derive, dynamic hint});

  Future<String> crateApiRustApiApiCreateDescriptorSecret(
      {required Network network,
      required String mnemonic,
      String? password,
      dynamic hint});

  Future<String> crateApiRustApiApiCreateEsploraBlockchainWithApi(
      {required EsploraConfig config, dynamic hint});

  Future<String> crateApiRustApiApiCreateTransaction(
      {required List<int> tx, dynamic hint});

  Future<String> crateApiRustApiApiCreateWallet(
  ...
  Future<String> crateApiRustApiApiDeriveDescriptorSecret(
      {required String secret, required String path, dynamic hint});

  Future<String> crateApiRustApiApiDescriptorAsString(
      {required String descriptor, required Network network, dynamic hint});

  Future<String> crateApiRustApiApiDescriptorAsStringPrivate(
      {required String descriptor, required Network network, dynamic hint});

  Future<String> crateApiRustApiApiDescriptorPublicFromString(
      {required String publicKey, dynamic hint});

  Future<String> crateApiRustApiApiDescriptorSecretAsPublic(
      {required String secret, dynamic hint});

  Future<Uint8List> crateApiRustApiApiDescriptorSecretAsSecretBytes(
      {required String secret, dynamic hint});

  Future<String> crateApiRustApiApiDescriptorSecretFromString(
      {required String secret, dynamic hint});

  Future<double> crateApiRustApiApiEstimateFee(
      {required int target, required String blockchainId, dynamic hint});

  Future<String> crateApiRustApiApiExtendDescriptorSecret(
      {required String secret, required String path, dynamic hint});

  Future<String> crateApiRustApiApiExtractTx(
      {required String psbtStr, dynamic hint});

  Future<String> crateApiRustApiApiGenerateSeedFromEntropy(
  ...
  Future<AddressInfo> crateApiRustApiApiGetAddress(
      {required String walletId,
      required AddressIndex addressIndex,
      dynamic hint});

  Future<Balance> crateApiRustApiApiGetBalance(
      {required String walletId, dynamic hint});

  Future<String> crateApiRustApiApiGetBlockchainHash(
      {required int blockchainHeight,
      required String blockchainId,
      dynamic hint});

  Future<(String, Network)> crateApiRustApiApiGetDescriptorForKeychain(
      {required String walletId, required KeychainKind keychain, dynamic hint});

  Future<int> crateApiRustApiApiGetHeight(
      {required String blockchainId, dynamic hint});

  Future<AddressInfo> crateApiRustApiApiGetInternalAddress(
      {required String walletId,
      required AddressIndex addressIndex,
      dynamic hint});

  Future<String> crateApiRustApiApiGetPsbtInput(
      {required String walletId,
  ...
  Future<List<TransactionDetails>> crateApiRustApiApiGetTransactions(
      {required String walletId, required bool includeRaw, dynamic hint});

  Future<List<TxIn>> crateApiRustApiApiInput(
      {required String tx, dynamic hint});

  Future<bool> crateApiRustApiApiIsCoinBase({required String tx, dynamic hint});

  Future<bool> crateApiRustApiApiIsExplicitlyRbf(
      {required String tx, dynamic hint});

  Future<bool> crateApiRustApiApiIsLockTimeEnabled(
      {required String tx, dynamic hint});

  Future<bool> crateApiRustApiApiIsMine(
      {required Script script, required String walletId, dynamic hint});

  Future<String> crateApiRustApiApiJsonSerialize(
      {required String psbtStr, dynamic hint});

  Future<List<LocalUtxo>> crateApiRustApiApiListUnspent(
      {required String walletId, dynamic hint});

  Future<List<LocalUtxo>> crateApiRustApiApiListUnspentOutputs(
      {required String walletId, dynamic hint});

  Future<int> crateApiRustApiApiLockTime({required String tx, dynamic hint});

  Future<int> crateApiRustApiApiMaxSatisfactionWeight(
      {required String descriptor, required Network network, dynamic hint});

  Future<String> crateApiRustApiApiNewBip44Descriptor(
      {required KeychainKind keyChainKind,
      required String secretKey,
      required Network network,
      dynamic hint});

  Future<String> crateApiRustApiApiNewBip44Public(
      {required KeychainKind keyChainKind,
  ...
  Future<String> crateApiRustApiApiNewBip49Descriptor(
      {required KeychainKind keyChainKind,
      required String secretKey,
      required Network network,
      dynamic hint});

  Future<String> crateApiRustApiApiNewBip49Public(
      {required KeychainKind keyChainKind,
      required String publicKey,
      required Network network,
      required String fingerprint,
  ...
  Future<String> crateApiRustApiApiNewBip84Descriptor(
      {required KeychainKind keyChainKind,
      required String secretKey,
      required Network network,
      dynamic hint});

  Future<String> crateApiRustApiApiNewBip84Public(
      {required KeychainKind keyChainKind,
      required String publicKey,
      required Network network,
      required String fingerprint,
  ...
  Future<List<TxOut>> crateApiRustApiApiOutput(
      {required String tx, dynamic hint});

  Future<int?> crateApiRustApiApiPsbtFeeAmount(
      {required String psbtStr, dynamic hint});

  Future<double?> crateApiRustApiApiPsbtFeeRate(
      {required String psbtStr, dynamic hint});

  Future<String> crateApiRustApiApiPsbtTxid(
      {required String psbtStr, dynamic hint});

  Future<String> crateApiRustApiApiSerializePsbt(
      {required String psbtStr, dynamic hint});

  Future<String?> crateApiRustApiApiSign(
      {required String walletId,
      required String psbtStr,
      SignOptions? signOptions,
      dynamic hint});

  Future<int> crateApiRustApiApiSize({required String tx, dynamic hint});

  Future<void> crateApiRustApiApiSyncWallet(
      {required String walletId, required String blockchainId, dynamic hint});

  Future<(String, TransactionDetails)> crateApiRustApiApiTxBuilderFinish(
      {required String walletId,
  ...
  Future<String> crateApiRustApiApiTxTxid({required String tx, dynamic hint});

  Future<int> crateApiRustApiApiVersion({required String tx, dynamic hint});

  Future<int> crateApiRustApiApiVsize({required String tx, dynamic hint});

  Future<Network> crateApiRustApiApiWalletNetwork(
      {required String walletId, dynamic hint});

  Future<int> crateApiRustApiApiWeight({required String tx, dynamic hint});

  Future<MyTestObject> crateApiRustObjectsMyTestObjectNew({dynamic hint});

  Future<String> crateApiRustObjectsMyTestObjectReadText(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiApiServiceProtonApiServiceProtonApiServiceInitApiService(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiApiServiceProtonApiServiceProtonApiServiceInitApiServiceConstMeta,
  ...
  TaskConstMeta
      get kCrateApiApiServiceProtonApiServiceProtonApiServiceInitApiServiceConstMeta =>
          const TaskConstMeta(
  ...
  Future<String> crateApiApiServiceProtonApiServiceProtonApiServiceReadText(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiApiServiceProtonApiServiceProtonApiServiceReadTextConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiApiServiceProtonApiServiceProtonApiServiceReadTextConstMeta =>
          const TaskConstMeta(
  ...
  void crateApiApiServiceWalletAuthStoreProtonWalletAuthStoreSetDartCallback(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiApiServiceWalletAuthStoreProtonWalletAuthStoreSetDartCallbackConstMeta,
      argValues: [callback],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiApiServiceWalletAuthStoreProtonWalletAuthStoreSetDartCallbackConstMeta =>
          const TaskConstMeta(
            debugName: "proton_wallet_auth_store_set_dart_callback",
            argNames: ["callback"],
          );
  ...
  String crateApiBdkWalletBdkWalletManagerFingerprint(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiBdkWalletBdkWalletManagerFingerprintConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiBdkWalletBdkWalletManagerFingerprintConstMeta =>
      const TaskConstMeta(
  ...
  Future<BdkWalletManager> crateApiBdkWalletBdkWalletManagerNew(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiBdkWalletBdkWalletManagerNewConstMeta,
  ...
  TaskConstMeta get kCrateApiBdkWalletBdkWalletManagerNewConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> crateApiLdkApiAddTwo(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLdkApiAddTwoConstMeta,
      argValues: [left, right],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLdkApiAddTwoConstMeta => const TaskConstMeta(
        debugName: "add_two",
        argNames: ["left", "right"],
      );
  ...
  Future<String> crateApiLdkApiTestOne({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLdkApiTestOneConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLdkApiTestOneConstMeta => const TaskConstMeta(
        debugName: "test_one",
        argNames: [],
      );
  ...
  Future<List<WalletBitcoinAddress>> crateApiProtonApiAddBitcoinAddresses(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_wallet_bitcoin_address,
        decodeErrorData: sse_decode_api_error,
      ),
  ...
  Future<String> crateApiProtonApiBroadcastRawTransaction(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiBroadcastRawTransactionConstMeta,
      argValues: [
  ...
  TaskConstMeta get kCrateApiProtonApiBroadcastRawTransactionConstMeta =>
      const TaskConstMeta(
  ...
  Future<WalletData> crateApiProtonApiCreateWallet(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiCreateWalletConstMeta,
      argValues: [walletReq],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiProtonApiCreateWalletConstMeta =>
      const TaskConstMeta(
  ...
  Future<WalletAccount> crateApiProtonApiCreateWalletAccount(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiCreateWalletAccountConstMeta,
  ...
  TaskConstMeta get kCrateApiProtonApiCreateWalletAccountConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<ProtonContactEmails>> crateApiProtonApiGetContacts(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_proton_contact_emails,
        decodeErrorData: sse_decode_api_error,
      ),
  ...
  Future<void> crateApiProtonApiInitApiService(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiInitApiServiceConstMeta,
      argValues: [userName, password],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiProtonApiInitApiServiceConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiProtonApiInitApiServiceAuthStore(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiInitApiServiceAuthStoreConstMeta,
  ...
  TaskConstMeta get kCrateApiProtonApiInitApiServiceAuthStoreConstMeta =>
      const TaskConstMeta(
        debugName: "init_api_service_auth_store",
        argNames: [
          "uid",
          "access",
          "refresh",
  ...
  Future<void> crateApiProtonApiInitApiServiceFromAuthAndVersion(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonApiInitApiServiceFromAuthAndVersionConstMeta,
      argValues: [uid, access, refresh, scopes, appVersion, userAgent, env],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiProtonApiInitApiServiceFromAuthAndVersionConstMeta =>
          const TaskConstMeta(
            debugName: "init_api_service_from_auth_and_version",
            argNames: [
              "uid",
              "access",
              "refresh",
  ...
  Future<WalletBitcoinAddress> crateApiProtonApiUpdateBitcoinAddress(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_wallet_bitcoin_address,
        decodeErrorData: sse_decode_api_error,
      ),
  ...
  Future<Network> crateApiRustApiApiAddressNetwork(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiAddressNetworkConstMeta,
      argValues: [address],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiAddressNetworkConstMeta =>
      const TaskConstMeta(
  ...
  Future<Script> crateApiRustApiApiAddressToScriptPubkey(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiAddressToScriptPubkeyConstMeta,
      argValues: [address],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiAddressToScriptPubkeyConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiBroadcast(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiBroadcastConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiBroadcastConstMeta =>
      const TaskConstMeta(
  ...
  Future<(String, TransactionDetails)> crateApiRustApiApiBumpFeeTxBuilderFinish(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiBumpFeeTxBuilderFinishConstMeta,
      argValues: [
        txid,
        feeRate,
        allowShrinking,
  ...
  TaskConstMeta get kCrateApiRustApiApiBumpFeeTxBuilderFinishConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCombinePsbt(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCombinePsbtConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiCombinePsbtConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCreateDescriptor(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCreateDescriptorConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiCreateDescriptorConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCreateDescriptorPublic(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCreateDescriptorPublicConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiCreateDescriptorPublicConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCreateDescriptorSecret(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCreateDescriptorSecretConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiCreateDescriptorSecretConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCreateTransaction(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCreateTransactionConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiCreateTransactionConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiCreateWallet(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiCreateWalletConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiCreateWalletConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDeriveDescriptorSecret(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDeriveDescriptorSecretConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiDeriveDescriptorSecretConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDescriptorAsString(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorAsStringConstMeta,
      argValues: [descriptor, network],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorAsStringConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDescriptorAsStringPrivate(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorAsStringPrivateConstMeta,
      argValues: [descriptor, network],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorAsStringPrivateConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDescriptorPublicFromString(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorPublicFromStringConstMeta,
      argValues: [publicKey],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorPublicFromStringConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDescriptorSecretAsPublic(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorSecretAsPublicConstMeta,
      argValues: [secret],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorSecretAsPublicConstMeta =>
      const TaskConstMeta(
  ...
  Future<Uint8List> crateApiRustApiApiDescriptorSecretAsSecretBytes(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorSecretAsSecretBytesConstMeta,
      argValues: [secret],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorSecretAsSecretBytesConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiDescriptorSecretFromString(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiDescriptorSecretFromStringConstMeta,
      argValues: [secret],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiDescriptorSecretFromStringConstMeta =>
      const TaskConstMeta(
  ...
  Future<double> crateApiRustApiApiEstimateFee(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiEstimateFeeConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiEstimateFeeConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiExtendDescriptorSecret(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiExtendDescriptorSecretConstMeta,
      argValues: [secret, path],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiExtendDescriptorSecretConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiExtractTx(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiExtractTxConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiExtractTxConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiGenerateSeedFromEntropy(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGenerateSeedFromEntropyConstMeta,
      argValues: [entropy],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiGenerateSeedFromEntropyConstMeta =>
      const TaskConstMeta(
  ...
  Future<AddressInfo> crateApiRustApiApiGetAddress(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetAddressConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetAddressConstMeta =>
      const TaskConstMeta(
  ...
  Future<Balance> crateApiRustApiApiGetBalance(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetBalanceConstMeta,
      argValues: [walletId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiGetBalanceConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiGetBlockchainHash(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetBlockchainHashConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetBlockchainHashConstMeta =>
      const TaskConstMeta(
  ...
  Future<(String, Network)> crateApiRustApiApiGetDescriptorForKeychain(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetDescriptorForKeychainConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetDescriptorForKeychainConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiGetHeight(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetHeightConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetHeightConstMeta =>
      const TaskConstMeta(
  ...
  Future<AddressInfo> crateApiRustApiApiGetInternalAddress(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetInternalAddressConstMeta,
      argValues: [walletId, addressIndex],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiGetInternalAddressConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiGetPsbtInput(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetPsbtInputConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetPsbtInputConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<TransactionDetails>> crateApiRustApiApiGetTransactions(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiGetTransactionsConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiGetTransactionsConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<TxIn>> crateApiRustApiApiInput(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiInputConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiInputConstMeta => const TaskConstMeta(
        debugName: "api_input",
        argNames: ["tx"],
      );

  @override
  Future<bool> crateApiRustApiApiIsCoinBase(
      {required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
      ...
      constMeta: kCrateApiRustApiApiIsCoinBaseConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiIsCoinBaseConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiRustApiApiIsExplicitlyRbf(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiIsExplicitlyRbfConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiIsExplicitlyRbfConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiRustApiApiIsLockTimeEnabled(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiIsLockTimeEnabledConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiIsLockTimeEnabledConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiRustApiApiIsMine(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiIsMineConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiIsMineConstMeta => const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiJsonSerialize(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiJsonSerializeConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiJsonSerializeConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<LocalUtxo>> crateApiRustApiApiListUnspent(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiListUnspentConstMeta,
      argValues: [walletId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiListUnspentConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<LocalUtxo>> crateApiRustApiApiListUnspentOutputs(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiListUnspentOutputsConstMeta,
      argValues: [walletId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiListUnspentOutputsConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiLockTime({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiLockTimeConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiLockTimeConstMeta => const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiMaxSatisfactionWeight(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiMaxSatisfactionWeightConstMeta,
      argValues: [descriptor, network],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiMaxSatisfactionWeightConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip44Descriptor(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip44DescriptorConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip44DescriptorConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip44Public(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip44PublicConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip44PublicConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip49Descriptor(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip49DescriptorConstMeta,
      argValues: [keyChainKind, secretKey, network],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip49DescriptorConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip49Public(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip49PublicConstMeta,
      argValues: [keyChainKind, publicKey, network, fingerprint],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip49PublicConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip84Descriptor(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip84DescriptorConstMeta,
      argValues: [keyChainKind, secretKey, network],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip84DescriptorConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiNewBip84Public(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiNewBip84PublicConstMeta,
      argValues: [keyChainKind, publicKey, network, fingerprint],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiNewBip84PublicConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<TxOut>> crateApiRustApiApiOutput(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiOutputConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiOutputConstMeta => const TaskConstMeta(
  ...
  Future<int?> crateApiRustApiApiPsbtFeeAmount(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiPsbtFeeAmountConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiPsbtFeeAmountConstMeta =>
      const TaskConstMeta(
  ...
  Future<double?> crateApiRustApiApiPsbtFeeRate(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiPsbtFeeRateConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiPsbtFeeRateConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiPsbtTxid(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiPsbtTxidConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiPsbtTxidConstMeta => const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiSerializePsbt(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiSerializePsbtConstMeta,
      argValues: [psbtStr],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiSerializePsbtConstMeta =>
      const TaskConstMeta(
  ...
  Future<String?> crateApiRustApiApiSign(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiSignConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiSignConstMeta => const TaskConstMeta(
        debugName: "api_sign",
  ...
  Future<int> crateApiRustApiApiSize({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiSizeConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiSizeConstMeta => const TaskConstMeta(
        debugName: "api_size",
        argNames: ["tx"],
      );
  ...
  Future<void> crateApiRustApiApiSyncWallet(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiSyncWalletConstMeta,
  ...
  TaskConstMeta get kCrateApiRustApiApiSyncWalletConstMeta =>
      const TaskConstMeta(
  ...
  Future<(String, TransactionDetails)> crateApiRustApiApiTxBuilderFinish(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiTxBuilderFinishConstMeta,
      argValues: [
        walletId,
        recipients,
        utxos,
  ...
  TaskConstMeta get kCrateApiRustApiApiTxBuilderFinishConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustApiApiTxTxid({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiTxTxidConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiTxTxidConstMeta => const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiVersion({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiVersionConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiVersionConstMeta => const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiVsize({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiVsizeConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiVsizeConstMeta => const TaskConstMeta(
        debugName: "api_vsize",
        argNames: ["tx"],
      );
  ...
  Future<Network> crateApiRustApiApiWalletNetwork(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiWalletNetworkConstMeta,
      argValues: [walletId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiWalletNetworkConstMeta =>
      const TaskConstMeta(
  ...
  Future<int> crateApiRustApiApiWeight({required String tx, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustApiApiWeightConstMeta,
      argValues: [tx],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustApiApiWeightConstMeta => const TaskConstMeta(
  ...
  Future<MyTestObject> crateApiRustObjectsMyTestObjectNew({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustObjectsMyTestObjectNewConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustObjectsMyTestObjectNewConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiRustObjectsMyTestObjectReadText(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiRustObjectsMyTestObjectReadTextConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiRustObjectsMyTestObjectReadTextConstMeta =>
      const TaskConstMeta(
  ...
  ApiUserSettings dco_decode_box_autoadd_api_user_settings(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_api_user_settings(raw);
  }
  ...
  ProtonWallet dco_decode_box_autoadd_proton_wallet(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_proton_wallet(raw);
  }

  @protected
  ProtonWalletKey dco_decode_box_autoadd_proton_wallet_key(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_proton_wallet_key(raw);
  }
  ...
  WalletAccount dco_decode_box_autoadd_wallet_account(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_wallet_account(raw);
  }

  @protected
  WalletSettings dco_decode_box_autoadd_wallet_settings(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_wallet_settings(raw);
  }
  ...
  List<ProtonContactEmails> dco_decode_list_proton_contact_emails(dynamic raw) {
    ...
    return (raw as List<dynamic>)
        .map(dco_decode_proton_contact_emails)
        .toList();
  }
  ...
  List<WalletBitcoinAddress> dco_decode_list_wallet_bitcoin_address(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_wallet_bitcoin_address)
        .toList();
  }
  ...
  ApiUserSettings? dco_decode_opt_box_autoadd_api_user_settings(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_api_user_settings(raw);
  }
  ...
  ProtonWallet? dco_decode_opt_box_autoadd_proton_wallet(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_proton_wallet(raw);
  }

  @protected
  ProtonWalletKey? dco_decode_opt_box_autoadd_proton_wallet_key(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_proton_wallet_key(raw);
  }
  ...
  WalletAccount? dco_decode_opt_box_autoadd_wallet_account(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_wallet_account(raw);
  }

  @protected
  WalletSettings? dco_decode_opt_box_autoadd_wallet_settings(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_wallet_settings(raw);
  }
  ...
  @protected
  ProtonWalletAuthStore dco_decode_proton_wallet_auth_store(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 0)
      throw Exception('unexpected arr length: expect 0 but see ${arr.length}');
    return ProtonWalletAuthStore();
  }
  ...
  WalletAccount dco_decode_wallet_account(dynamic raw) {
    ...
    return WalletAccount(
      ...
      addresses: dco_decode_list_email_address(arr[5]),
    );
  }
  ...
  WalletAccountEvent dco_decode_wallet_account_event(dynamic raw) {
    ...
    return WalletAccountEvent(
      id: dco_decode_String(arr[0]),
      action: dco_decode_u_32(arr[1]),
      walletAccount: dco_decode_opt_box_autoadd_wallet_account(arr[2]),
    );
  }
  ...
  WalletEvent dco_decode_wallet_event(dynamic raw) {
    ...
    return WalletEvent(
      id: dco_decode_String(arr[0]),
      action: dco_decode_u_32(arr[1]),
      wallet: dco_decode_opt_box_autoadd_proton_wallet(arr[2]),
    );
  }
  ...
  WalletKeyEvent dco_decode_wallet_key_event(dynamic raw) {
    ...
    return WalletKeyEvent(
      id: dco_decode_String(arr[0]),
      action: dco_decode_u_32(arr[1]),
      walletKey: dco_decode_opt_box_autoadd_proton_wallet_key(arr[2]),
    );
  }
  ...
  WalletSettingsEvent dco_decode_wallet_settings_event(dynamic raw) {
    ...
    return WalletSettingsEvent(
      id: dco_decode_String(arr[0]),
      action: dco_decode_u_32(arr[1]),
      walletSettings: dco_decode_opt_box_autoadd_wallet_settings(arr[2]),
    );
  }
  ...
  ApiUserSettings sse_decode_box_autoadd_api_user_settings(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_api_user_settings(deserializer));
  }
  ...
  ProtonWallet sse_decode_box_autoadd_proton_wallet(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_proton_wallet(deserializer));
  }
  ...
  ProtonWalletKey sse_decode_box_autoadd_proton_wallet_key(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_proton_wallet_key(deserializer));
  }
  ...
  WalletAccount sse_decode_box_autoadd_wallet_account(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_wallet_account(deserializer));
  }
  ...
  WalletSettings sse_decode_box_autoadd_wallet_settings(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_wallet_settings(deserializer));
  }
  ...
  EmailAddress sse_decode_email_address(SseDeserializer deserializer) {
    ...
    return EmailAddress(id: var_id, email: var_email);
  }
  ...
  List<EmailAddress> sse_decode_list_email_address(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <EmailAddress>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_email_address(deserializer));
    }
    return ans_;
  }
  ...
  List<ProtonContactEmails> sse_decode_list_proton_contact_emails(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ProtonContactEmails>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_proton_contact_emails(deserializer));
    }
    return ans_;
  }
  ...
  List<WalletBitcoinAddress> sse_decode_list_wallet_bitcoin_address(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <WalletBitcoinAddress>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_wallet_bitcoin_address(deserializer));
    }
    return ans_;
  }
  ...
  ApiUserSettings? sse_decode_opt_box_autoadd_api_user_settings(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_api_user_settings(deserializer));
    } else {
      return null;
    }
  }
  ...
  ProtonWallet? sse_decode_opt_box_autoadd_proton_wallet(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_proton_wallet(deserializer));
    } else {
      return null;
    }
  }
  ...
  ProtonWalletKey? sse_decode_opt_box_autoadd_proton_wallet_key(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_proton_wallet_key(deserializer));
    } else {
      return null;
    }
  }
  ...
  WalletAccount? sse_decode_opt_box_autoadd_wallet_account(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_wallet_account(deserializer));
    } else {
      return null;
    }
  }
  ...
  WalletSettings? sse_decode_opt_box_autoadd_wallet_settings(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_wallet_settings(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  ProtonWalletAuthStore sse_decode_proton_wallet_auth_store(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return ProtonWalletAuthStore();
  }
  ...
  WalletAccount sse_decode_wallet_account(SseDeserializer deserializer) {
    ...
    var var_label = sse_decode_String(deserializer);
    var var_scriptType = sse_decode_u_8(deserializer);
    var var_addresses = sse_decode_list_email_address(deserializer);
    return WalletAccount(
        id: var_id,
        walletId: var_walletId,
        derivationPath: var_derivationPath,
  ...
  WalletAccountEvent sse_decode_wallet_account_event(
    ...
    var var_walletAccount =
        sse_decode_opt_box_autoadd_wallet_account(deserializer);
    return WalletAccountEvent(
  ...
  WalletEvent sse_decode_wallet_event(SseDeserializer deserializer) {
    ...
    var var_id = sse_decode_String(deserializer);
    var var_action = sse_decode_u_32(deserializer);
    var var_wallet = sse_decode_opt_box_autoadd_proton_wallet(deserializer);
  ...
  WalletKeyEvent sse_decode_wallet_key_event(SseDeserializer deserializer) {
    ...
    var var_action = sse_decode_u_32(deserializer);
    var var_walletKey =
        sse_decode_opt_box_autoadd_proton_wallet_key(deserializer);
    return WalletKeyEvent(
  ...
  WalletSettingsEvent sse_decode_wallet_settings_event(
    ...
    var var_walletSettings =
        sse_decode_opt_box_autoadd_wallet_settings(deserializer);
    return WalletSettingsEvent(
  ...
  void sse_encode_box_autoadd_api_user_settings(
      ApiUserSettings self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_api_user_settings(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_proton_wallet(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_proton_wallet(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_proton_wallet_key(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_proton_wallet_key(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_wallet_account(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_wallet_account(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_wallet_settings(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_wallet_settings(self, serializer);
  }
  ...
  void sse_encode_list_email_address(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_email_address(item, serializer);
    }
  }
  ...
  void sse_encode_list_proton_contact_emails(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_proton_contact_emails(item, serializer);
    }
  }
  ...
  void sse_encode_list_wallet_bitcoin_address(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_wallet_bitcoin_address(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_api_user_settings(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_api_user_settings(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_proton_wallet(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_proton_wallet(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_proton_wallet_key(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_proton_wallet_key(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_wallet_account(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_wallet_account(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_wallet_settings(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_wallet_settings(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_proton_wallet_auth_store(
  ...
  void sse_encode_wallet_account(WalletAccount self, SseSerializer serializer) {
    ...
    sse_encode_String(self.label, serializer);
    sse_encode_u_8(self.scriptType, serializer);
    sse_encode_list_email_address(self.addresses, serializer);
  }
  ...
  void sse_encode_wallet_account_event(
    ...
    sse_encode_String(self.id, serializer);
    sse_encode_u_32(self.action, serializer);
    sse_encode_opt_box_autoadd_wallet_account(self.walletAccount, serializer);
  }
  ...
  void sse_encode_wallet_event(WalletEvent self, SseSerializer serializer) {
    ...
    sse_encode_String(self.id, serializer);
    sse_encode_u_32(self.action, serializer);
    sse_encode_opt_box_autoadd_proton_wallet(self.wallet, serializer);
  }
  ...
  void sse_encode_wallet_key_event(
    ...
    sse_encode_String(self.id, serializer);
    sse_encode_u_32(self.action, serializer);
    sse_encode_opt_box_autoadd_proton_wallet_key(self.walletKey, serializer);
  }
  ...
  void sse_encode_wallet_settings_event(
    ...
    sse_encode_String(self.id, serializer);
    sse_encode_u_32(self.action, serializer);
    sse_encode_opt_box_autoadd_wallet_settings(self.walletSettings, serializer);
  }
