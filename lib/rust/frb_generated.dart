...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1099483387;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String>
      crateApiApiServiceOnrampGatewayClientOnRampGatewayClientGetPublicApiKey(
          {required OnRampGatewayClient that,
          required GatewayProvider provider});
  ...
  Future<void> crateApiApiServiceWalletClientWalletClientMigrate(
      {required WalletClient that,
      required String walletId,
  ...
  String crateApiCryptoWalletKeyFrbUnlockedWalletKeyToBase64(
      {required FrbUnlockedWalletKey that});

  Uint8List crateApiCryptoWalletKeyFrbUnlockedWalletKeyToEntropy(
      {required FrbUnlockedWalletKey that});

  String crateApiCryptoWalletKeyHelperFrbWalletKeyHelperDecrypt(
      {required String base64SecureKey, required String encryptText});

  String crateApiCryptoWalletKeyHelperFrbWalletKeyHelperEncrypt(
  ...
  Uint8List crateApiCryptoWalletKeyHelperFrbWalletKeyHelperGetSecureRandom(
      {required BigInt length});

  Future<void> crateApiDbAppDatabaseHelperFrbAppDatabaseBuildDatabase(
      {required FrbAppDatabase that, required int oldVersion});

  Future<void> crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWallet(
      {required FrbAppDatabase that, required String walletId});

  Future<void> crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletAccount(
      {required FrbAppDatabase that, required String accountId});

  Future<List<AccountModel>>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccounts(
          {required FrbAppDatabase that});

  Future<List<AccountModel>>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccountsByWalletId(
          {required FrbAppDatabase that, required String walletId});

  Future<List<WalletModel>>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWallets(
          {required FrbAppDatabase that});

  Future<List<WalletModel>>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletsByUserId(
          {required FrbAppDatabase that, required String userId});

  Future<WalletModel?>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetDefaultWalletByUserId(
          {required FrbAppDatabase that, required String userId});

  Future<AccountModel?>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletAccountByAccountId(
          {required FrbAppDatabase that, required String accountId});

  Future<WalletModel?>
      crateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletByWalletId(
          {required FrbAppDatabase that, required String walletId});

  FrbAppDatabase crateApiDbAppDatabaseHelperFrbAppDatabaseNew(
      {required String databaseUrl});

  Future<WalletModel?> crateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWallet(
      {required FrbAppDatabase that, required WalletModel wallet});

  Future<AccountModel?>
      crateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWalletAccount(
          {required FrbAppDatabase that, required AccountModel account});
  ...
  Future<ApiWalletAccount>
      crateApiProtonWalletFeaturesWalletCreationFrbWalletCreationCreateWalletAccount(
          {required FrbWalletCreation that,
          required String walletId,
          required String label,
          required int accountIndex});
  ...
  Future<void>
      crateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreClearAuthDartCallback(
          {required FrbWalletKeyStore that});

  FrbWalletKeyStore
      crateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreNew();

  Future<void>
      crateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetGetWalletKeysCallback(
          {required FrbWalletKeyStore that,
          required FutureOr<List<ApiWalletKey>> Function() callback});

  Future<void>
      crateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetSaveWalletKeysCallback(
          {required FrbWalletKeyStore that,
          required FutureOr<void> Function(List<ApiWalletKey>) callback});

  Future<FrbWalletCreation>
      crateApiProtonWalletWalletFrbProtonWalletGetWalletCrateionFeature(
          {required FrbProtonWallet that});

  Future<FrbProtonWallet> crateApiProtonWalletWalletFrbProtonWalletNew(
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbAppDatabase;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbAppDatabase;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_FrbAppDatabasePtr;
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbProtonWallet;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbProtonWallet;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_FrbProtonWalletPtr;
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbUnlockedWalletKey;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbUnlockedWalletKey;
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbWalletCreation;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbWalletCreation;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_FrbWalletCreationPtr;

  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbWalletKeyStore;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbWalletKeyStore;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_FrbWalletKeyStorePtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiApiServiceOnrampGatewayClientOnRampGatewayClientGetPublicApiKeyConstMeta,
  ...
  TaskConstMeta
      get kCrateApiApiServiceOnrampGatewayClientOnRampGatewayClientGetPublicApiKeyConstMeta =>
          const TaskConstMeta(
            debugName: "OnRampGatewayClient_get_public_api_key",
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerWalletClient(
            that, serializer);
        sse_encode_String(walletId, serializer);
        sse_encode_box_autoadd_migrated_wallet(migratedWallet, serializer);
        sse_encode_list_migrated_wallet_account(
            migratedWalletAccounts, serializer);
        sse_encode_list_migrated_wallet_transaction(
            migratedWalletTransactions, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiApiServiceWalletClientWalletClientMigrateConstMeta,
      argValues: [
        that,
        walletId,
        migratedWallet,
        migratedWalletAccounts,
        migratedWalletTransactions
      ],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiApiServiceWalletClientWalletClientMigrateConstMeta =>
          const TaskConstMeta(
            debugName: "WalletClient_migrate",
            argNames: [
              "that",
              "walletId",
              "migratedWallet",
  ...
  FrbAccount crateApiBdkWalletAccountFrbAccountNew(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_box_autoadd_wallet_mobile_connector_factory(
  ...
  WalletMobileConnectorFactory
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_wallet_mobile_connector_factory,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateApiBdkWalletStorageWalletMobileConnectorFactoryNewConstMeta,
  ...
  TaskConstMeta
      get kCrateApiBdkWalletStorageWalletMobileConnectorFactoryNewConstMeta =>
          const TaskConstMeta(
            debugName: "wallet_mobile_connector_factory_new",
            argNames: ["folderPath"],
          );
  ...
  FrbAccount crateApiBdkWalletWalletFrbWalletAddAccount(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, scriptType, derivationPath, connectorFactory],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiBdkWalletWalletFrbWalletAddAccountConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["that", "scriptType", "derivationPath", "connectorFactory"],
      );
  ...
  String crateApiCryptoWalletKeyFrbUnlockedWalletKeyToBase64(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCryptoWalletKeyFrbUnlockedWalletKeyToBase64ConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCryptoWalletKeyFrbUnlockedWalletKeyToBase64ConstMeta =>
          const TaskConstMeta(
            debugName: "FrbUnlockedWalletKey_to_base64",
            argNames: ["that"],
          );
  ...
  Uint8List crateApiCryptoWalletKeyFrbUnlockedWalletKeyToEntropy(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCryptoWalletKeyFrbUnlockedWalletKeyToEntropyConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCryptoWalletKeyFrbUnlockedWalletKeyToEntropyConstMeta =>
          const TaskConstMeta(
            debugName: "FrbUnlockedWalletKey_to_entropy",
            argNames: ["that"],
          );
  ...
  String crateApiCryptoWalletKeyHelperFrbWalletKeyHelperDecrypt(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(base64SecureKey, serializer);
        sse_encode_String(encryptText, serializer);
      ...
      constMeta:
          kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperDecryptConstMeta,
      argValues: [base64SecureKey, encryptText],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperDecryptConstMeta =>
          const TaskConstMeta(
            debugName: "frb_wallet_key_helper_decrypt",
            argNames: ["base64SecureKey", "encryptText"],
          );
  ...
  String crateApiCryptoWalletKeyHelperFrbWalletKeyHelperEncrypt(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperEncryptConstMeta,
      argValues: [base64SecureKey, plaintext],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperEncryptConstMeta =>
          const TaskConstMeta(
            debugName: "frb_wallet_key_helper_encrypt",
            argNames: ["base64SecureKey", "plaintext"],
          );
  ...
  FrbUnlockedWalletKey
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGenerateSecretKeyConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGenerateSecretKeyConstMeta =>
          const TaskConstMeta(
            debugName: "frb_wallet_key_helper_generate_secret_key",
            argNames: [],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGenerateSecretKeyAsBase64ConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGenerateSecretKeyAsBase64ConstMeta =>
          const TaskConstMeta(
            debugName: "frb_wallet_key_helper_generate_secret_key_as_base64",
            argNames: [],
          );
  ...
  Uint8List crateApiCryptoWalletKeyHelperFrbWalletKeyHelperGetSecureRandom(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGetSecureRandomConstMeta,
      argValues: [length],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCryptoWalletKeyHelperFrbWalletKeyHelperGetSecureRandomConstMeta =>
          const TaskConstMeta(
            debugName: "frb_wallet_key_helper_get_secure_random",
            argNames: ["length"],
          );
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_RefMut_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase(
            that, serializer);
        sse_encode_u_32(oldVersion, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseBuildDatabaseConstMeta,
      argValues: [that, oldVersion],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseBuildDatabaseConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_build_database",
            argNames: ["that", "oldVersion"],
          );
  ...
  Future<void> crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWallet(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletConstMeta,
      argValues: [that, walletId],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_delete_wallet",
            argNames: ["that", "walletId"],
          );
  ...
  Future<void> crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletAccount(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletAccountConstMeta,
      argValues: [that, accountId],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletAccountConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_delete_wallet_account",
            argNames: ["that", "accountId"],
          );
  ...
  Future<List<AccountModel>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_account_model,
        decodeErrorData: sse_decode_bridge_error,
      ),
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccountsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccountsConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_all_wallet_accounts",
            argNames: ["that"],
          );
  ...
  Future<List<AccountModel>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccountsByWalletIdConstMeta,
      argValues: [that, walletId],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccountsByWalletIdConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_all_wallet_accounts_by_wallet_id",
            argNames: ["that", "walletId"],
          );
  ...
  Future<List<WalletModel>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_wallet_model,
        decodeErrorData: sse_decode_bridge_error,
      ),
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletsConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_all_wallets",
            argNames: ["that"],
          );
  ...
  Future<List<WalletModel>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletsByUserIdConstMeta,
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletsByUserIdConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_all_wallets_by_user_id",
  ...
  Future<WalletModel?>
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_wallet_model,
        decodeErrorData: sse_decode_bridge_error,
      ),
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetDefaultWalletByUserIdConstMeta,
      argValues: [that, userId],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetDefaultWalletByUserIdConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_default_wallet_by_user_id",
            argNames: ["that", "userId"],
          );
  ...
  Future<AccountModel?>
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_account_model,
        decodeErrorData: sse_decode_bridge_error,
      ),
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletAccountByAccountIdConstMeta,
      argValues: [that, accountId],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletAccountByAccountIdConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_wallet_account_by_account_id",
            argNames: ["that", "accountId"],
          );
  ...
  Future<WalletModel?>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletByWalletIdConstMeta,
      argValues: [that, walletId],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseGetWalletByWalletIdConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_get_wallet_by_wallet_id",
            argNames: ["that", "walletId"],
          );
  ...
  FrbAppDatabase crateApiDbAppDatabaseHelperFrbAppDatabaseNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiDbAppDatabaseHelperFrbAppDatabaseNewConstMeta,
      argValues: [databaseUrl],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDbAppDatabaseHelperFrbAppDatabaseNewConstMeta =>
      const TaskConstMeta(
        debugName: "FrbAppDatabase_new",
  ...
  Future<WalletModel?> crateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWallet(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase(
            that, serializer);
        sse_encode_box_autoadd_wallet_model(wallet, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWalletConstMeta,
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWalletConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_upsert_wallet",
  ...
  Future<AccountModel?>
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase(
            that, serializer);
        sse_encode_box_autoadd_account_model(account, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWalletAccountConstMeta,
      argValues: [that, account],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWalletAccountConstMeta =>
          const TaskConstMeta(
            debugName: "FrbAppDatabase_upsert_wallet_account",
            argNames: ["that", "account"],
          );
  ...
  Future<ApiWalletAccount>
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(walletId, serializer);
        sse_encode_String(label, serializer);
        sse_encode_i_32(accountIndex, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiProtonWalletFeaturesWalletCreationFrbWalletCreationCreateWalletAccountConstMeta,
      argValues: [that, walletId, label, accountIndex],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiProtonWalletFeaturesWalletCreationFrbWalletCreationCreateWalletAccountConstMeta =>
          const TaskConstMeta(
            debugName: "FrbWalletCreation_create_wallet_account",
            argNames: ["that", "walletId", "label", "accountIndex"],
          );
  ...
  Future<void>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreClearAuthDartCallbackConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreClearAuthDartCallbackConstMeta =>
          const TaskConstMeta(
            debugName: "FrbWalletKeyStore_clear_auth_dart_callback",
            argNames: ["that"],
          );
  ...
  FrbWalletKeyStore
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreNewConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreNewConstMeta =>
          const TaskConstMeta(
            debugName: "FrbWalletKeyStore_new",
            argNames: [],
          );
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_RefMut_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletKeyStore(
            that, serializer);
        sse_encode_DartFn_Inputs__Output_list_api_wallet_key_AnyhowException(
            callback, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetGetWalletKeysCallbackConstMeta,
      argValues: [that, callback],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetGetWalletKeysCallbackConstMeta =>
          const TaskConstMeta(
            debugName: "FrbWalletKeyStore_set_get_wallet_keys_callback",
            argNames: ["that", "callback"],
          );
  ...
  Future<void>
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_RefMut_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletKeyStore(
            that, serializer);
        sse_encode_DartFn_Inputs_list_api_wallet_key_Output_unit_AnyhowException(
            callback, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta:
          kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetSaveWalletKeysCallbackConstMeta,
      argValues: [that, callback],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiProtonWalletStorageWalletKeyStoreFrbWalletKeyStoreSetSaveWalletKeysCallbackConstMeta =>
          const TaskConstMeta(
            debugName: "FrbWalletKeyStore_set_save_wallet_keys_callback",
            argNames: ["that", "callback"],
          );
  ...
  Future<FrbWalletCreation>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta:
          kCrateApiProtonWalletWalletFrbProtonWalletGetWalletCrateionFeatureConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiProtonWalletWalletFrbProtonWalletGetWalletCrateionFeatureConstMeta =>
          const TaskConstMeta(
            debugName: "FrbProtonWallet_get_wallet_crateion_feature",
            argNames: ["that"],
          );
  ...
  Future<FrbProtonWallet> crateApiProtonWalletWalletFrbProtonWalletNew(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProtonWalletWalletFrbProtonWalletNewConstMeta,
      argValues: [api, dbPath],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProtonWalletWalletFrbProtonWalletNewConstMeta =>
      const TaskConstMeta(
        debugName: "FrbProtonWallet_new",
        argNames: ["api", "dbPath"],
      );
  ...
  Future<void> Function(
    int,
  ) encode_DartFn_Inputs__Output_list_api_wallet_key_AnyhowException(
      FutureOr<List<ApiWalletKey>> Function() raw) {
    return (
      callId,
    ) async {
      Box<List<ApiWalletKey>>? rawOutput;
      Box<AnyhowException>? rawError;
      try {
      ...
      if (rawOutput != null) {
        serializer.buffer.putUint8(0);
        sse_encode_list_api_wallet_key(rawOutput.value, serializer);
      } else {
        serializer.buffer.putUint8(1);
        sse_encode_AnyhowException(rawError!.value, serializer);
      }
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_list_api_wallet_key_Output_unit_AnyhowException(
          FutureOr<void> Function(List<ApiWalletKey>) raw) {
    return (callId, rawArg0) async {
      final arg0 = dco_decode_list_api_wallet_key(rawArg0);
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbAppDatabase => wire
          .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbAppDatabase => wire
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbProtonWallet => wire
          .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbProtonWallet;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_FrbProtonWallet => wire
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_FrbUnlockedWalletKey => wire
  ...
  FrbAppDatabase
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return FrbAppDatabaseImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  FrbProtonWallet
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbProtonWallet(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return FrbProtonWalletImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  FrbWalletCreation
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletCreation(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return FrbWalletCreationImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  FrbWalletKeyStore
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletKeyStore(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return FrbWalletKeyStoreImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  AccountModel dco_decode_account_model(dynamic raw) {
    ...
    return AccountModel(
      ...
      scriptType: dco_decode_u_32(arr[5]),
      createTime: dco_decode_u_64(arr[6]),
      modifyTime: dco_decode_u_64(arr[7]),
      fiatCurrency: dco_decode_String(arr[8]),
      priority: dco_decode_u_32(arr[9]),
      lastUsedIndex: dco_decode_u_32(arr[10]),
      poolSize: dco_decode_u_32(arr[11]),
    );
  }
  ...
  AccountModel dco_decode_box_autoadd_account_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_account_model(raw);
  }
  ...
  MigratedWallet dco_decode_box_autoadd_migrated_wallet(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_migrated_wallet(raw);
  }
  ...
  WalletMobileConnectorFactory
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_wallet_mobile_connector_factory(raw);
  }

  @protected
  WalletModel dco_decode_box_autoadd_wallet_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_wallet_model(raw);
  }
  ...
  List<AccountModel> dco_decode_list_account_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_account_model).toList();
  }
  ...
  List<ApiWalletKey> dco_decode_list_api_wallet_key(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_api_wallet_key).toList();
  }
  ...
  List<MigratedWalletAccount> dco_decode_list_migrated_wallet_account(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_migrated_wallet_account)
        .toList();
  }
  ...
  List<MigratedWalletTransaction> dco_decode_list_migrated_wallet_transaction(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_migrated_wallet_transaction)
        .toList();
  }
  ...
  List<WalletModel> dco_decode_list_wallet_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_wallet_model).toList();
  }
  ...
  MigratedWallet dco_decode_migrated_wallet(dynamic raw) {
    ...
    return MigratedWallet(
      ...
      walletKey: dco_decode_String(arr[2]),
      walletKeySignature: dco_decode_String(arr[3]),
      mnemonic: dco_decode_String(arr[4]),
  ...
  @protected
  MigratedWalletTransaction dco_decode_migrated_wallet_transaction(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4)
  ...
  AccountModel? dco_decode_opt_box_autoadd_account_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_account_model(raw);
  }
  ...
  WalletModel? dco_decode_opt_box_autoadd_wallet_model(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_wallet_model(raw);
  }
  ...
  WalletMobileConnectorFactory dco_decode_wallet_mobile_connector_factory(
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return WalletMobileConnectorFactory.raw(
  ...
  WalletModel dco_decode_wallet_model(dynamic raw) {
    ...
    return WalletModel(
      id: dco_decode_u_32(arr[0]),
      name: dco_decode_String(arr[1]),
      passphrase: dco_decode_u_32(arr[2]),
      publicKey: dco_decode_String(arr[3]),
      imported: dco_decode_u_32(arr[4]),
      priority: dco_decode_u_32(arr[5]),
      status: dco_decode_u_32(arr[6]),
      type: dco_decode_u_32(arr[7]),
      createTime: dco_decode_u_32(arr[8]),
      modifyTime: dco_decode_u_32(arr[9]),
      userId: dco_decode_String(arr[10]),
      walletId: dco_decode_String(arr[11]),
      accountCount: dco_decode_u_32(arr[12]),
      balance: dco_decode_f_64(arr[13]),
  ...
  FrbAppDatabase
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbAppDatabase(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return FrbAppDatabaseImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  FrbProtonWallet
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbProtonWallet(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return FrbProtonWalletImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  FrbWalletCreation
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletCreation(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return FrbWalletCreationImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  FrbWalletKeyStore
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerFrbWalletKeyStore(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return FrbWalletKeyStoreImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  AccountModel sse_decode_account_model(SseDeserializer deserializer) {
    ...
    var var_scriptType = sse_decode_u_32(deserializer);
    var var_createTime = sse_decode_u_64(deserializer);
    var var_modifyTime = sse_decode_u_64(deserializer);
  ...
  ApiWalletUserSettings sse_decode_api_wallet_user_settings(
    ...
    var var_receiveEmailIntegrationNotification =
        sse_decode_opt_box_autoadd_u_8(deserializer);
    var var_receiveTransactionNotification =
        sse_decode_opt_box_autoadd_u_8(deserializer);
  ...
  AccountModel sse_decode_box_autoadd_account_model(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_account_model(deserializer));
  }
  ...
  MigratedWallet sse_decode_box_autoadd_migrated_wallet(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_migrated_wallet(deserializer));
  }
  ...
  WalletMobileConnectorFactory
      sse_decode_box_autoadd_wallet_mobile_connector_factory(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_wallet_mobile_connector_factory(deserializer));
  }

  @protected
  WalletModel sse_decode_box_autoadd_wallet_model(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_wallet_model(deserializer));
  }
  ...
  List<AccountModel> sse_decode_list_account_model(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AccountModel>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_account_model(deserializer));
    }
    return ans_;
  }
  ...
  List<ApiWalletKey> sse_decode_list_api_wallet_key(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ApiWalletKey>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_wallet_key(deserializer));
    }
    return ans_;
  }
  ...
  List<MigratedWalletAccount> sse_decode_list_migrated_wallet_account(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MigratedWalletAccount>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_migrated_wallet_account(deserializer));
    }
    return ans_;
  }
  ...
  List<MigratedWalletTransaction> sse_decode_list_migrated_wallet_transaction(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MigratedWalletTransaction>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_migrated_wallet_transaction(deserializer));
    }
    return ans_;
  }
  ...
  List<WalletModel> sse_decode_list_wallet_model(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <WalletModel>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_wallet_model(deserializer));
    }
    return ans_;
  }
  ...
  MigratedWalletAccount sse_decode_migrated_wallet_account(
    ...
    var var_id = sse_decode_String(deserializer);
    var var_label = sse_decode_String(deserializer);
    return MigratedWalletAccount(id: var_id, label: var_label);
  }
  ...
  AccountModel? sse_decode_opt_box_autoadd_account_model(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_account_model(deserializer));
    } else {
      return null;
    }
  }
  ...
  WalletModel? sse_decode_opt_box_autoadd_wallet_model(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_wallet_model(deserializer));
    } else {
      return null;
    }
  }
  ...
  WalletMobileConnectorFactory sse_decode_wallet_mobile_connector_factory(
    ...
    return WalletMobileConnectorFactory.raw(folderPath: var_folderPath);
  }
  ...
  WalletModel sse_decode_wallet_model(SseDeserializer deserializer) {
    ...
    var var_id = sse_decode_u_32(deserializer);
    var var_name = sse_decode_String(deserializer);
    var var_passphrase = sse_decode_u_32(deserializer);
    var var_publicKey = sse_decode_String(deserializer);
    var var_imported = sse_decode_u_32(deserializer);
    var var_priority = sse_decode_u_32(deserializer);
    var var_status = sse_decode_u_32(deserializer);
    var var_type = sse_decode_u_32(deserializer);
    var var_createTime = sse_decode_u_32(deserializer);
    var var_modifyTime = sse_decode_u_32(deserializer);
    var var_userId = sse_decode_String(deserializer);
    var var_walletId = sse_decode_String(deserializer);
    var var_accountCount = sse_decode_u_32(deserializer);
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbAppDatabaseImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbProtonWalletImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbUnlockedWalletKeyImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletCreationImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletKeyStoreImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbAppDatabaseImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletKeyStoreImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbProtonWalletImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbUnlockedWalletKeyImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletCreationImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  void sse_encode_DartFn_Inputs__Output_list_api_wallet_key_AnyhowException(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs__Output_list_api_wallet_key_AnyhowException(self),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbAppDatabaseImpl).frbInternalSseEncode(move: null),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbProtonWalletImpl).frbInternalSseEncode(move: null),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletCreationImpl).frbInternalSseEncode(move: null),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as FrbWalletKeyStoreImpl).frbInternalSseEncode(move: null),
        serializer);
  }
  ...
  void sse_encode_account_model(AccountModel self, SseSerializer serializer) {
    ...
    sse_encode_u_32(self.scriptType, serializer);
    sse_encode_u_64(self.createTime, serializer);
    sse_encode_u_64(self.modifyTime, serializer);
  ...
  void sse_encode_box_autoadd_account_model(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_account_model(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_migrated_wallet(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_migrated_wallet(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_wallet_mobile_connector_factory(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_wallet_mobile_connector_factory(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_wallet_model(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_wallet_model(self, serializer);
  }
  ...
  void sse_encode_list_account_model(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_account_model(item, serializer);
    }
  }
  ...
  void sse_encode_list_api_wallet_key(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_wallet_key(item, serializer);
    }
  }
  ...
  void sse_encode_list_migrated_wallet_account(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_migrated_wallet_account(item, serializer);
    }
  }
  ...
  void sse_encode_list_migrated_wallet_transaction(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_migrated_wallet_transaction(item, serializer);
    }
  }
  ...
  void sse_encode_list_wallet_model(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_wallet_model(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_account_model(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_account_model(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_wallet_model(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_wallet_model(self, serializer);
    }
  }
  ...
  void sse_encode_wallet_model(WalletModel self, SseSerializer serializer) {
    ...
    sse_encode_u_32(self.id, serializer);
    sse_encode_String(self.name, serializer);
    sse_encode_u_32(self.passphrase, serializer);
    sse_encode_String(self.publicKey, serializer);
    sse_encode_u_32(self.imported, serializer);
    sse_encode_u_32(self.priority, serializer);
    sse_encode_u_32(self.status, serializer);
    sse_encode_u_32(self.type, serializer);
    sse_encode_u_32(self.createTime, serializer);
    sse_encode_u_32(self.modifyTime, serializer);
    sse_encode_String(self.userId, serializer);
    sse_encode_String(self.walletId, serializer);
    sse_encode_u_32(self.accountCount, serializer);
...
@sealed
class FrbAppDatabaseImpl extends RustOpaque implements FrbAppDatabase {
  // Not to be used by end users
  FrbAppDatabaseImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FrbAppDatabaseImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_FrbAppDatabase,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbAppDatabase,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbAppDatabasePtr,
  );

  /// Expose functions in appDatabase
  Future<void> buildDatabase({required int oldVersion}) => RustLib.instance.api
      .crateApiDbAppDatabaseHelperFrbAppDatabaseBuildDatabase(
          that: this, oldVersion: oldVersion);

  Future<void> deleteWallet({required String walletId}) => RustLib.instance.api
      .crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWallet(
          that: this, walletId: walletId);

  Future<void> deleteWalletAccount({required String accountId}) =>
      RustLib.instance.api
          .crateApiDbAppDatabaseHelperFrbAppDatabaseDeleteWalletAccount(
              that: this, accountId: accountId);

  Future<List<AccountModel>> getAllWalletAccounts() => RustLib.instance.api
          .crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWalletAccounts(
        that: this,
      );
  ...
  Future<List<WalletModel>> getAllWallets() => RustLib.instance.api
          .crateApiDbAppDatabaseHelperFrbAppDatabaseGetAllWallets(
        that: this,
      );
  ...
  Future<WalletModel?> upsertWallet({required WalletModel wallet}) =>
      RustLib.instance.api
          .crateApiDbAppDatabaseHelperFrbAppDatabaseUpsertWallet(
...
@sealed
class FrbProtonWalletImpl extends RustOpaque implements FrbProtonWallet {
  // Not to be used by end users
  FrbProtonWalletImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FrbProtonWalletImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_FrbProtonWallet,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbProtonWallet,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbProtonWalletPtr,
  );

  Future<FrbWalletCreation> getWalletCrateionFeature() => RustLib.instance.api
          .crateApiProtonWalletWalletFrbProtonWalletGetWalletCrateionFeature(
        that: this,
      );
}
...
@sealed
class FrbUnlockedWalletKeyImpl extends RustOpaque
    implements FrbUnlockedWalletKey {
  // Not to be used by end users
  FrbUnlockedWalletKeyImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FrbUnlockedWalletKeyImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance.api.rust_arc_increment_strong_count_FrbUnlockedWalletKey,
    rustArcDecrementStrongCount: RustLib
        .instance.api.rust_arc_decrement_strong_count_FrbUnlockedWalletKey,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_FrbUnlockedWalletKeyPtr,
  );

  String toBase64() =>
      RustLib.instance.api.crateApiCryptoWalletKeyFrbUnlockedWalletKeyToBase64(
        that: this,
      );
...
@sealed
class FrbWalletCreationImpl extends RustOpaque implements FrbWalletCreation {
  // Not to be used by end users
  FrbWalletCreationImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FrbWalletCreationImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_FrbWalletCreation,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbWalletCreation,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_FrbWalletCreationPtr,
  );
...
@sealed
class FrbWalletKeyStoreImpl extends RustOpaque implements FrbWalletKeyStore {
  // Not to be used by end users
  FrbWalletKeyStoreImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  FrbWalletKeyStoreImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_FrbWalletKeyStore,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_FrbWalletKeyStore,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_FrbWalletKeyStorePtr,
  );
...
class OnRampGatewayClientImpl extends RustOpaque
  ...
  Future<String> getPublicApiKey({required GatewayProvider provider}) => RustLib
      .instance.api
      .crateApiApiServiceOnrampGatewayClientOnRampGatewayClientGetPublicApiKey(
...
class WalletClientImpl extends RustOpaque implements WalletClient {
  ...
  Future<void> migrate(
          ...
          required MigratedWallet migratedWallet,
          required List<MigratedWalletAccount> migratedWalletAccounts,
          required List<MigratedWalletTransaction>
              migratedWalletTransactions}) =>
      RustLib.instance.api.crateApiApiServiceWalletClientWalletClientMigrate(
          that: this,
          walletId: walletId,
